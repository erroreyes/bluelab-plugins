...
Axis3DFactory *Axis3DFactory::mInstance = NULL;

Axis3DFactory *
Axis3DFactory::Get()
{
    if (mInstance == NULL)
        mInstance = new Axis3DFactory();
    
    return mInstance;
}

Axis3DFactory::~Axis3DFactory() {}

void
Axis3DFactory::Reset(int bufferSize, BL_FLOAT sampleRate)
{
...
Axis3D *
Axis3DFactory::CreateAmpAxis(Orientation orientation)
{
    // Linear scale
...
Axis3D *
Axis3DFactory::CreateAmpDbAxis(Orientation orientation)
{
    // Db scale
...
Axis3D *
Axis3DFactory::CreateFreqAxis(Orientation orientation)
{
    // Create axis
...
Axis3D *
Axis3DFactory::CreateChromaAxis(Orientation orientation)
{
    // Create axis
...
Axis3D *
Axis3DFactory::CreateAngleAxis(Orientation orientation)
{
    // Create axis
...
Axis3D *
Axis3DFactory::CreateLeftRightAxis(Orientation orientation)
{
    // Create axis
...
Axis3D *
Axis3DFactory::CreateMinusOneOneAxis(Orientation orientation)
{
    // Create axis
...
Axis3D *
Axis3DFactory::CreatePercentAxis(Orientation orientation)
{
    // Create axis
...
Axis3D *
Axis3DFactory::CreateEmptyAxis(Orientation orientation)
{
    // Create axis
...
void
Axis3DFactory::ComputeExtremities(Orientation orientation, BL_FLOAT p0[3], BL_FLOAT p1[3])
{
...
BL_FLOAT
Axis3DFactory::FreqToMelNorm(BL_FLOAT freq, int bufferSize, BL_FLOAT sampleRate)
{
    // Convert to Mel
