...
#ifndef __BL__BLClipperDisplay__
#define __BL__BLClipperDisplay__
...
//
// BLClipperDisplay: from USTClipperDisplay4
//
// NOTE: Not used for the moment, it's here just in case
//
class BLClipperDisplay
{
public:
    BLClipperDisplay(BL_GUI_FLOAT sampleRate);
    
    virtual ~BLClipperDisplay();
