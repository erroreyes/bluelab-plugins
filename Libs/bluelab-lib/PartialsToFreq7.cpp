...
PartialsToFreq7::PartialsToFreq7(int bufferSize, int oversampling,
...
PartialsToFreq7::~PartialsToFreq7()
{
    delete mChromaObj;
}

void
PartialsToFreq7::Reset(int bufferSize, int oversampling,
                       int freqRes, BL_FLOAT sampleRate)
{
...
void
PartialsToFreq7::SetHarmonicSoundFlag(bool flag) {}

BL_FLOAT
PartialsToFreq7::ComputeFrequency(const WDL_TypedBuf<BL_FLOAT> &magns,
...
BL_FLOAT
PartialsToFreq7::AdjustFreqToPartial(BL_FLOAT freq,
                                     const vector<Partial> &partials)
{
...
void
PartialsToFreq7::ThresholdPartials(vector<Partial> *partials)
{
#if 0
...
void
PartialsToFreq7::ThresholdPartialsRelative(vector<Partial> *partials)
{
#if 0
    vector<Partial> result;
...
BL_FLOAT
PartialsToFreq7::FindBestOctave(BL_FLOAT inFreq,
                                const vector<Partial> &partials)
{
    vector<Partial> partials0 = partials;
    sort(partials0.begin(), partials0.end(), Partial::FreqLess);
...
BL_FLOAT
PartialsToFreq7::FindBestOctave2(BL_FLOAT inFreq,
