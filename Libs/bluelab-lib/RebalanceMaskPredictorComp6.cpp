                                                         ...
                                                         const IPluginBase &plug)
{
    ...
    mModel->LoadWin(graphics, MODEL_ID, WEIGHTS_ID);
#endif
...
void
RebalanceMaskPredictorComp6::Reset()
{
...
void
RebalanceMaskPredictorComp6::Reset(int bufferSize, int overlapping,
...
void
RebalanceMaskPredictorComp6::ProcessInputFft(vector<WDL_TypedBuf<WDL_FFT_COMPLEX> * > *ioFftSamples,
...
void
RebalanceMaskPredictorComp6::SetPredictModuloNum(int moduloNum)
{
    switch(moduloNum)
    {
        case 0:
...
int
RebalanceMaskPredictorComp6::GetHistoryIndex()
{
...
int
RebalanceMaskPredictorComp6::GetLatency()
{
...
void
RebalanceMaskPredictorComp6::SetMasksContrast(BL_FLOAT contrast)
{
...
void
RebalanceMaskPredictorComp6::ColumnsToBuffer(WDL_TypedBuf<BL_FLOAT> *buf,
...
void
RebalanceMaskPredictorComp6::ColumnsToBuffer(WDL_TypedBuf<WDL_FFT_COMPLEX> *buf,
...
void
RebalanceMaskPredictorComp6::ComputeMasks(WDL_TypedBuf<BL_FLOAT> masks[NUM_STEM_SOURCES],
...
void
RebalanceMaskPredictorComp6::ComputeLineMask(WDL_TypedBuf<BL_FLOAT> *maskResult,
...
void
RebalanceMaskPredictorComp6::ComputeLineMasks(WDL_TypedBuf<BL_FLOAT> masksResult[NUM_STEM_SOURCES],
...
void
RebalanceMaskPredictorComp6::UpdateCurrentMasksAdd(const vector<WDL_TypedBuf<BL_FLOAT> > &newMasks)
{
...
void
RebalanceMaskPredictorComp6::ApplySensitivity(WDL_TypedBuf<BL_FLOAT> masks[NUM_STEM_SOURCES])
{
...
void
RebalanceMaskPredictorComp6::ApplySensitivityHard(BL_FLOAT masks[NUM_STEM_SOURCES])
{
    for (int i = 0; i < NUM_STEM_SOURCES; i++)
    {
...
void
RebalanceMaskPredictorComp6::ApplySensitivitySoft(BL_FLOAT masks[NUM_STEM_SOURCES])
{
    for (int i = 0; i < NUM_STEM_SOURCES; i++)
    {
...
void
RebalanceMaskPredictorComp6::NormalizeMasks(WDL_TypedBuf<BL_FLOAT> masks[NUM_STEM_SOURCES])
{
    for (int i = 0; i < masks[0].GetSize(); i++)
    {
        BL_FLOAT vals[NUM_STEM_SOURCES];
...
void
RebalanceMaskPredictorComp6::InitMixCols()
{
    mMixCols.clear();
