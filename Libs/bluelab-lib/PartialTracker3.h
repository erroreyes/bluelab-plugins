...
#ifndef __BL_SASViewer__PartialTracker3__
#define __BL_SASViewer__PartialTracker3__
...
public:
    ...
    PartialTracker3(int bufferSize, BL_FLOAT sampleRate,
                    BL_FLOAT overlapping);
    
    virtual ~PartialTracker3();
...
protected:
    ...
    int FindPartialById(const vector<PartialTracker3::Partial> &partials, int idx);
    
    // Associate partials
    //
    void AssociatePartials(const vector<PartialTracker3::Partial> &prevPartials,
                           vector<PartialTracker3::Partial> *currentPartials,
                           vector<PartialTracker3::Partial> *remainingPartials);
    
    // Still used ?
    void SmoothPartials(const vector<PartialTracker3::Partial> &prevPartials,
                        vector<PartialTracker3::Partial> *currentPartials);
...
#endif /* defined(__BL_SASViewer__PartialTracker3__) */
