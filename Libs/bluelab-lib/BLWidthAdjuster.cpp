...
// For BLCorrelationComputer3 and 4
//
...
BLWidthAdjuster::BLWidthAdjuster(BL_FLOAT sampleRate)
{
    ...
    mCorrComputerDbg = new BLCorrelationComputer2(sampleRate,
                                                  CORRELATION_SMOOTH_TIME_MS);
...
#if 0
// Works with BLWidthAdjuster2 (version with atan2())
BL_FLOAT
BLWidthAdjuster::ApplyCompWidth(BL_FLOAT width, BL_FLOAT compGain,
                                  BL_FLOAT corr)
{
