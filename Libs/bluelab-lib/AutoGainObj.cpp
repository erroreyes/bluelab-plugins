...
#define GAIN_SMOOTHER_SMOOTH_COEFF_MIN 0.9
#define GAIN_SMOOTHER_SMOOTH_COEFF_MAX 0.99

// With 0.9, we have too much lag !
// With 0.5, this looks good
// (and this make a better vumeter display)
#define SAMPLES_SMOOTHER_SMOOTH_COEFF 0.5
...
BL_FLOAT
AutoGainObj::ComputeOutGainSpectConstantSc(const vector<WDL_TypedBuf<BL_FLOAT> > &inSamples,
