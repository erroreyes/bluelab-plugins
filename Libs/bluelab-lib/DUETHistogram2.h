...
#ifndef __BL_DUET__DUETHistogram2__
#define __BL_DUET__DUETHistogram2__
...
// DUETHistogram2: from DUETHistogram

class DUETHistogram2
{
public:
    DUETHistogram2(int width, int height, BL_FLOAT maxValue);
    
    virtual ~DUETHistogram2();
    
    void Reset();
    
    void Reset(int width, int height, BL_FLOAT maxValue);
...
#endif /* defined(__BL_DUET__DUETHistogram2__) */
