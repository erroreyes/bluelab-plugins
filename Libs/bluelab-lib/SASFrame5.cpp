...
SASFrame5::SASPartial::SASPartial(const SASPartial &other)
{
    mFreq = other.mFreq;
    mAmp = other.mAmp;
    mPhase = other.mPhase;
...
bool
SASFrame5::SASPartial::AmpLess(const SASPartial &p1, const SASPartial &p2)
{
...
void
SASFrame5::Reset(BL_FLOAT sampleRate)
{
    mPartials.clear();
    mPrevPartials.clear();
...
void
SASFrame5::Reset(int bufferSize, int oversampling,
...
void
SASFrame5::SetMinAmpDB(BL_FLOAT ampDB)
{
    mMinAmpDB = ampDB;
}

void
SASFrame5::SetSynthMode(enum SynthMode mode)
{
    mSynthMode = mode;
}
...
void
SASFrame5::SetSynthOddPartials(bool flag)
{
...
void
SASFrame5::SetNoiseEnvelope(const WDL_TypedBuf<BL_FLOAT> &noiseEnv)
{
    mNoiseEnvelope = noiseEnv;
}

void
SASFrame5::GetNoiseEnvelope(WDL_TypedBuf<BL_FLOAT> *noiseEnv) const
{
    *noiseEnv = mNoiseEnvelope;
}

void
SASFrame5::SetInputData(const WDL_TypedBuf<BL_FLOAT> &magns,
...
BL_FLOAT
SASFrame5::GetAmplitude() const
{
    return mAmplitude*mAmpFactor;
}

BL_FLOAT
SASFrame5::GetFrequency() const
{
    return mFrequency*mFreqFactor;
}

void
SASFrame5::GetColor(WDL_TypedBuf<BL_FLOAT> *color) const
{
    *color = mColor;
...
void
SASFrame5::GetNormWarping(WDL_TypedBuf<BL_FLOAT> *warping) const
{
...
void
SASFrame5::SetAmplitude(BL_FLOAT amp)
{
    mAmplitude = amp;
}

void
SASFrame5::SetFrequency(BL_FLOAT freq)
{
    mFrequency = freq;
}

void
SASFrame5::SetColor(const WDL_TypedBuf<BL_FLOAT> &color)
{
    mPrevColor = mColor;
...
void
SASFrame5::SetNormWarping(const WDL_TypedBuf<BL_FLOAT> &warping)
{
...
void
SASFrame5::ComputeSamplesPost(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
SASFrame5::ComputeSamples(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
SASFrame5::ComputeSamplesResynth(WDL_TypedBuf<BL_FLOAT> *samples)
{
#if COMPUTE_SAS_FFT
...
void
SASFrame5::ComputeSamplesPartialsRAW(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
void
SASFrame5::ComputeSamplesPartials(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
void
SASFrame5::ComputeSamplesSAS(WDL_TypedBuf<BL_FLOAT> *samples)
{
#if DEBUG_DUMP_VALUES
...
void
SASFrame5::ComputeSamplesSASOverlap(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
void
SASFrame5::ComputeFftSAS(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
void
SASFrame5::ComputeFftSASFreqAdjust(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
void
SASFrame5::ComputeSamplesSASTable(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
    BLUtils::FillAllZero(samples);
...
void
SASFrame5::ComputeSamplesSASTable2(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
    BLUtils::FillAllZero(samples);
...
void
SASFrame5::SetAmpFactor(BL_FLOAT factor)
{
    mAmpFactor = factor;
}

void
SASFrame5::SetFreqFactor(BL_FLOAT factor)
{
    mFreqFactor = factor;
}

void
SASFrame5::SetColorFactor(BL_FLOAT factor)
{
    mColorFactor = factor;
}

void
SASFrame5::SetWarpingFactor(BL_FLOAT factor)
{
...
BL_FLOAT
SASFrame5::ApplyNormWarping(BL_FLOAT freq)
{
...
BL_FLOAT
SASFrame5::ApplyColor(BL_FLOAT freq)
{
    BL_FLOAT hzPerBin = mSampleRate/mBufferSize;
...
BL_FLOAT
SASFrame5::ApplyNormWarping(BL_FLOAT freq, BL_FLOAT t)
{
#if DBG_DISABLE_WARPING
    return freq;
#endif
...
BL_FLOAT
SASFrame5::ApplyColor(BL_FLOAT freq, BL_FLOAT t)
{
    BL_FLOAT hzPerBin = mSampleRate/mBufferSize;
    int idx = freq/hzPerBin;
    if (idx > mColor.GetSize())
...
bool
SASFrame5::FindPartial(BL_FLOAT freq)
{
...
int
SASFrame5::FindPrevPartialIdx(int currentPartialIdx)
{
...
void
SASFrame5::GetSASPartial(SASPartial *result, int index, BL_FLOAT t)
{
...
void
SASFrame5::MixFrames(SASFrame5 *result,
...
BL_FLOAT
SASFrame5::GetFreq(BL_FLOAT freq0, BL_FLOAT freq1, BL_FLOAT t)
{
#if INTERP_RESCALE
    // Mel scale
...
BL_FLOAT
SASFrame5::GetAmp(BL_FLOAT amp0, BL_FLOAT amp1, BL_FLOAT t)
{
#if INTERP_RESCALE
...
BL_FLOAT
SASFrame5::GetCol(BL_FLOAT col0, BL_FLOAT col1, BL_FLOAT t)
{
#if INTERP_RESCALE
...
BL_FLOAT
SASFrame5::ApplyColorFactor(BL_FLOAT color, BL_FLOAT factor)
{
#if 0
    // Naive
...
void
SASFrame5::ApplyColorFactor(WDL_TypedBuf<BL_FLOAT> *color, BL_FLOAT factor)
{
