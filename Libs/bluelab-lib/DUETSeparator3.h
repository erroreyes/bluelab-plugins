...
#ifndef __BL_DUET__DUETSeparator3__
#define __BL_DUET__DUETSeparator3__
...
// DUETSeparator2: from DUETSeparator
// - code clean
//
// DUETSeparator3: from DUETSeparator2
// avoid the gating effect by using SoftMaskComp3 + center data
//
class DUETSeparator3
{
public:
    DUETSeparator3(int histogramSize, BL_FLOAT sampleRate,
                   int bufferSize, int overlapping,
                   int softMaskSize);
    
    virtual ~DUETSeparator3();
    
    void Reset(BL_FLOAT sampleRate, int bufferSize, int overlapping);
    ...
    void GetDelayedInputDataComp(WDL_TypedBuf<WDL_FFT_COMPLEX> fftData[2]);
...
protected:
    ...
    WDL_TypedBuf<WDL_FFT_COMPLEX> mDelayedInputFftData[2];
    ...
    SoftMaskingComp3 *mSoftMaskingComp[2];
...
private:
    ...
    WDL_TypedBuf<int> mTmpBuf4;
    WDL_TypedBuf<BL_FLOAT> mTmpBuf5;
    WDL_TypedBuf<BL_FLOAT> mTmpBuf6[2];
    WDL_TypedBuf<WDL_FFT_COMPLEX> mTmpBuf7[2];
    WDL_TypedBuf<BL_FLOAT> mTmpBuf8[2];
    WDL_TypedBuf<WDL_FFT_COMPLEX> mTmpBuf9[2];
    WDL_TypedBuf<BL_FLOAT> mTmpBuf10;
};

#endif /* defined(__BL_DUET__DUETSeparator3__) */
