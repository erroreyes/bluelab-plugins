...
class RebalanceMaskProcessor
{
 public:
    ...
    void SetVocalContrast(BL_FLOAT contrast);
    void SetBassContrast(BL_FLOAT contrast);
    void SetDrumsContrast(BL_FLOAT contrast);
    void SetOtherContrast(BL_FLOAT contrast);
 ...
 protected:
    ...
    void ApplyMaskContrast(BL_FLOAT masks[NUM_STEM_SOURCES], BL_FLOAT contrast);
    ...
    BL_FLOAT mContrasts[NUM_STEM_SOURCES];
