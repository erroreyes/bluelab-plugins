...
#include "PartialsDiffEstimate.h"
...
PartialsDiffEstimate::PartialsDiffEstimate(int bufferSize, BL_FLOAT sampleRate)
{
    mBufferSize = bufferSize;
    mSampleRate = sampleRate;
}

PartialsDiffEstimate::~PartialsDiffEstimate() {}

BL_FLOAT
PartialsDiffEstimate::ComputeFrequency(const vector<PartialTracker3::Partial> &partials)
{
...
BL_FLOAT
PartialsDiffEstimate::ComputeFreqDiff(const vector<PartialTracker3::Partial> &partials)
{
...
// Doesn't work
BL_FLOAT
PartialsDiffEstimate::ComputeMinFreqDiff(const vector<PartialTracker3::Partial> &partials)
{
    // Compute frequency differences
    vector<BL_FLOAT> freqDiffs;
    for (int i = 0; i < partials.size() - 1; i++)
...
void
PartialsDiffEstimate::GenerateHarmonics(vector<PartialTracker3::Partial> *partials)
{
...
void
PartialsDiffEstimate::GenerateOctaves(vector<PartialTracker3::Partial> *partials)
{
    vector<PartialTracker3::Partial> result;
...
BL_FLOAT
PartialsDiffEstimate::AdjustFreqToPartial(BL_FLOAT freq,
...
BL_FLOAT
PartialsDiffEstimate::AdjustFreqToPartialOctave(BL_FLOAT freq,
                                           const vector<PartialTracker3::Partial> &partials)
{    
...
void
PartialsDiffEstimate::ThresholdPartials(vector<PartialTracker3::Partial> *partials)
{
    vector<PartialTracker3::Partial> result;
...
void
PartialsDiffEstimate::ThresholdPartialsRelative(vector<PartialTracker3::Partial> *partials)
{
    vector<PartialTracker3::Partial> result;
...
void
PartialsDiffEstimate::SelectAlivePartials(vector<PartialTracker3::Partial> *partials)
{
    vector<PartialTracker3::Partial> result;
