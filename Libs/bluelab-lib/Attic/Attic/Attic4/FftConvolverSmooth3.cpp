...
#include "FftConvolverSmooth3.h"


FftConvolverSmooth3::FftConvolverSmooth3(int bufferSize, bool normalize)
{
...
FftConvolverSmooth3::~FftConvolverSmooth3()
{
...
void
FftConvolverSmooth3::SetResponse(const WDL_TypedBuf<BL_FLOAT> *response)
{
...
bool
FftConvolverSmooth3::Process(BL_FLOAT *input, BL_FLOAT *output, int nFrames)
{
    if (mHasJustReset)
    {
        if (mNewResponse.GetSize() > 0)
