...
public:
    ...
    static void FftToSamples(const WDL_TypedBuf<double> &fftMagns,
...
protected:
    ...
    void CorrectEnvelope1(WDL_TypedBuf<double> *samples,
    ...
    void ApplyInverseWindow(WDL_TypedBuf<double> *magns,
...
protected:
    ...
    // DEBUG ?
    int GetEnvelopeShift(const WDL_TypedBuf<double> &envelope0,
                         const WDL_TypedBuf<double> &envelope1,
                         int precision = 1);
