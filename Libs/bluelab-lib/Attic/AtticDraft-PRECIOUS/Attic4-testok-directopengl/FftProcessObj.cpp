...
void
FftProcessObj::AddSamples(double *samples, int numSamples)
{
...
void
FftProcessObj::ProcessSamplesBuffer(WDL_TypedBuf<double> *ioBuffer) {}
...
void
FftProcessObj::GetResultOutBuffer(double *output, int nFrames)
{
    // Should not happen
...
bool
FftProcessObj::Process(double *input, double *output, int nFrames)
{
    // Process the data
