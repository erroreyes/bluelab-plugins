...
// BLSpectrogram3-old2: before global optimization
// BIG optimization: BLSpectrogram3::PhasesToStdVector managing pointers
// => doesn't optimize, even slow down a bit
                        ...
                        const WDL_TypedBuf<BL_FLOAT> &phases)
{
    ...
    if (mYLogScale)
    {
        Utils::LogScaleX(&magns0, mYLogScaleFactor);
        Utils::LogScaleX(&phases0, mYLogScaleFactor);
    }
    ...
    Utils::AmpToDBNorm(&dbMagns, magns0, 1e-15, -120.0);
                                ...
                                bool horizontal, bool vertical)
{
    ...
    if (horizontal)
    {
        ...
        for (int i = 0; i < mHeight; i++)
        {
            ...
            Utils::FindNextPhase(&prevPhase, 0.0);
                                  ...
                                  vector<WDL_TypedBuf<BL_FLOAT> *> *outPhases)
{
    ...
    for (int i = 0; i < numPhases; i++)
    {
        ...
        (*outPhases)[i] = (WDL_TypedBuf<BL_FLOAT> *)line;
    }
#endif
}
