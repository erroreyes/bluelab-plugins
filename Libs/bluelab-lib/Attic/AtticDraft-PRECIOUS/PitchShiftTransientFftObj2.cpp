//
//  PitchShiftTransientFftObj2.cpp
//  BL-PitchShift
//
...
#include "PitchShiftTransientFftObj2.h"
...
PitchShiftTransientFftObj2::PitchShiftTransientFftObj2(int bufferSize, int overlapping, int freqRes,
                                                     double sampleRate)
...
PitchShiftTransientFftObj2::~PitchShiftTransientFftObj2()
{
    delete mTransObj;
    delete mPitchObj;
}
...
void
PitchShiftTransientFftObj2::Reset(int overlapping, int freqRes, double sampleRate)
{
...
void
PitchShiftTransientFftObj2::SetPitchFactor(double factor)
{
    mPitchObj->SetPitchFactor(factor);
}

void
PitchShiftTransientFftObj2::SetTransBoost(double factor)
{
    mTransObj->SetSoftHard(factor);
}

void
PitchShiftTransientFftObj2::ProcessFftBuffer(WDL_TypedBuf<WDL_FFT_COMPLEX> *ioBuffer,
...
void
PitchShiftTransientFftObj2::ProcessSamplesBuffer(WDL_TypedBuf<double> *ioBuffer,
                                                WDL_TypedBuf<double> *scBuffer)
{
    ...
    // and it should be called before PitchShiftTransientFftObj2::ProcessSamplesBuffer() !!
...
void
PitchShiftTransientFftObj2::ProcessOneBuffer(const WDL_TypedBuf<double> &inBuffer,
