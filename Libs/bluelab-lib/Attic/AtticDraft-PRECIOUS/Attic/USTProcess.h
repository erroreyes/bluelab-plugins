...
public:
    ...
    static void ComputePolarLevel(const WDL_TypedBuf<double> samples[2],
                                  WDL_TypedBuf<double> polarLevelSamples[2],
                                  WDL_TypedBuf<double> *prevLevels = NULL,
                                  bool smoothMinMax = false);
    
    static void ComputeLissajous(const WDL_TypedBuf<double> samples[2],
...
protected:
    ...
    static double ApplyAngleShape(double angle, double shape);
};
