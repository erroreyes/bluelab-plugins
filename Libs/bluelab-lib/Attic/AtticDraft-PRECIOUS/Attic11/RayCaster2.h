...
#define RC_POINT_FLAG_COLORMAP_SET 0x4
        ...
        // TEST
        /*static inline bool IsCloserToCamera(const Point &p0, const Point &p1)
        {
            static const RC_FLOAT camPos[3] = { 0.0, 0.0, 0.0 };
            RC_FLOAT v0[3] = { p0.mX - camPos[0], p0.mY - camPos[1], p0.mZ - camPos[2] };
            RC_FLOAT d20 = v0[0]*v0[0] + v0[1]*v0[1] + v0[2]*v0[2];
            
            RC_FLOAT v1[3] = { p1.mX - camPos[0], p1.mY - camPos[1], p1.mZ - camPos[2] };
...
protected:
    ...
    static void TransformPointModel(const Point &p, Point *result,
                                    RC_FLOAT camAngle0);
    ...
    //int ComputeMostAlignedSlice(int width, int height, Axis axis,
    //                            int *sign = NULL, RC_FLOAT *alignedCoord = NULL,
    //                            RC_FLOAT *fixedCoord = NULL);
    ...
    //void DBG_DrawSlicesZ(NVGcontext *vg, int width, int height);
