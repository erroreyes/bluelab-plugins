...
public:
    ...
    virtual void Reset(int oversampling, int freqRes, double sampleRate);
...
public:
    ...
    virtual void Reset(int overlapping, int oversampling, double sampleRate) {}

    virtual void ProcessInputSamplesPre(vector<WDL_TypedBuf<double> * > *ioSamples) {}
    
    virtual void ProcessInputSamples(vector<WDL_TypedBuf<double> * > *ioSamples) {}

    virtual void ProcessInputSamplesWin(vector<WDL_TypedBuf<double> * > *ioSamples) {}
    ...
    virtual void ProcessResultSamplesWin(vector<WDL_TypedBuf<double> * > *ioSamples) {}

    virtual void ProcessResultSamples(vector<WDL_TypedBuf<double> * > *ioSamples) {}
};
...
public:
    ...
    FftProcessObj14(const vector<ProcessObj *> &processObjs,
    ...
    virtual bool Process(const vector<WDL_TypedBuf<double> > &inputs,
    ...
    WDL_TypedBuf<double> *GetChannelSamples(int channelNum);
    
    WDL_TypedBuf<WDL_FFT_COMPLEX> *GetChannelFft(int channelNum);
    
    WDL_TypedBuf<double> *GetChannelResultSamples(int channelNum);
    ...
    static void HalfMagnPhasesToSamples(const WDL_TypedBuf<double> &magns,
                                        const  WDL_TypedBuf<double> &phases,
                                        WDL_TypedBuf<double> *outSamples);
    
    static void SamplesToHalfMagnPhases(const WDL_TypedBuf<double> &inSamples,
                                        WDL_TypedBuf<double> *outMagns,
                                        WDL_TypedBuf<double> *outPhases);
    ...
    // Cepstrum
    static void MagnsToCepstrum(const WDL_TypedBuf<double> &halfMagns,
                                WDL_TypedBuf<double> *outCepstrum);
    
protected:
    virtual void AddSamples(const vector<WDL_TypedBuf<double> > &inputs,
                            const vector<WDL_TypedBuf<double> > &scInputs);
    ...
    bool GetResults(vector<WDL_TypedBuf<double> > *outputs, int numRequested);
    
    void SetupSideChain();
    
    //
    void GetAllSamples(vector<WDL_TypedBuf<double> * > *samples);
    void GetAllFftSamples(vector<WDL_TypedBuf<WDL_FFT_COMPLEX> * > *samples);
    void GetAllResultSamples(vector<WDL_TypedBuf<double> * > *samples);
