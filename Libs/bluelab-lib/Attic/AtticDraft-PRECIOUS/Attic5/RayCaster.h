...
// Point ids not used anymore
// OPTIM: optimize by 10% (86% -> 76%)
#define USE_POINT_IDS 0
...
//#if 0 // not used for the moment
    void SetAlphaScale(RC_FLOAT scale);
//#endif
...
protected:
    ...
    //void ProjectFace(RC_FLOAT projFace[2][3]);
...
#if 0 // OLD
    bool SelectionIntersectSlice2D(const RC_FLOAT selection2D[2][2],
    ...
    void BlendDepthSorting(unsigned char/*int*/ rgba[4], vector<Point> &points0);
