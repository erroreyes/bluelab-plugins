...
void
GraphCurve::SetYdBScale(bool flag, BL_FLOAT minYdB, BL_FLOAT maxYdB)
{
    mYdBScale = flag;
    mMinYdB = minYdB;
    mMaxYdB = maxYdB;
...
void
GraphCurve::FillAllValues(BL_FLOAT val)
{
...
void
GraphCurve::SetValues(const WDL_TypedBuf<BL_FLOAT> *values)
{
...
void
GraphCurve::SetValue(BL_FLOAT t, BL_FLOAT val)
{
...
void
GraphCurve::PushValue(BL_FLOAT val)
{
    if (mDoSmooth)
    {
