...
#ifndef __Transient__FftProcessObj10__
#define __Transient__FftProcessObj10__
...
//
class FftProcessObj10 //: public BufProcessObj
{
public:
    enum AnalysisMethod
    {
    ...
    FftProcessObj10(int bufferSize, int overlapping = 2, int freqRes = 1,
...
#endif /* defined(__Transient__FftProcessObj10__) */
