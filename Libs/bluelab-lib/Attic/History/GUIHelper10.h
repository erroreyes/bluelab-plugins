...
public:
...
#if USE_GRAPH_OGL
    GraphControl10 *CreateGraph10(IPlug *plug, IGraphics *graphics,
    ...
    // UST
    ITextControl * CreateUSTText(IPlug *plug, IGraphics *graphics, int textSize, int width,
                                 const IColor &color,
    ...
    // UST
    IControl *CreateSwitch(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
                           int x, int y, int param);
...
protected:
    ...
    // For UST
    void CreateGraphOverlay(IPlug *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
