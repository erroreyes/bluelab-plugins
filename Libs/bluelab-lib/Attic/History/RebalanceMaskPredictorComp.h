...
#ifndef __BL_Rebalance__RebalanceMaskPredictorComp__
#define __BL_Rebalance__RebalanceMaskPredictorComp__
...
class RebalanceMaskPredictorComp : public MultichannelProcess
{
public:
    RebalanceMaskPredictorComp(int bufferSize,
                               BL_FLOAT overlapping, BL_FLOAT oversampling,
                               BL_FLOAT sampleRate,
                               IGraphics *graphics);
    
    virtual ~RebalanceMaskPredictorComp();
...
#endif /* defined(__BL_Rebalance__RebalanceMaskPredictorComp__) */
