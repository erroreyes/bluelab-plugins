...
IColor GUIHelper7::mValueTextColor = IColor(255,
                                             VALUE_TEXT_COLOR_R,
                                             VALUE_TEXT_COLOR_G,
                                             VALUE_TEXT_COLOR_B);

GUIHelper7::GUIHelper7()
{
...
void
GUIHelper7::AddAllObjects(IGraphics *graphics)
{
#if GUI_OBJECTS_SORTING
...
ITextControl *
GUIHelper7::CreateValueText(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper7::CreateKnob(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper7::CreateKnob2(IPlug *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper7::CreateEnumKnob(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper7::CreateRadioButtons(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper7::CreateToggleButton(IPlug *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               int x, int y, int param, const char *title,
                               int diffuseId, const char *diffuseFn)
{
...
VuMeterControl *
GUIHelper7::CreateVuMeter(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
...
#if USE_GRAPH_OGL
GraphControl9 *
GUIHelper7::CreateGraph9(IPlug *plug, IGraphics *graphics, int param,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         ...
                         IBitmap **oBitmap)
{
    ...
    GraphControl9 *control = CreateGraph9(plug, graphics, param, x, y,
                         ...
                         int numCurves, int numPoints)
{
    ...
    GraphControl9 *control = new GraphControl9(plug, rect, param, numCurves, numPoints, pPath.Get());
...
GUIHelper7::CreateFileSelector(IPlug *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               ...
                               char* dir, char* extensions)
{
    ...
    IFileSelectorControl *control = new IFileSelectorControl(plug, pR, param, &bitmap,
...
void
GUIHelper7::CreateVersion(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper7::CreateBitmap(IPlug *plug, IGraphics *graphics,
                         int x, int y,
...
IBitmapControl *
GUIHelper7::CreateShadows(IPlug *plug, IGraphics *graphics, int bmpId, const char *bmpFn)
{
...
IBitmapControl *
GUIHelper7::CreateLogo(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper7::CreatePlugName(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
    IBitmap bmp = graphics->LoadIBitmap(bmpId, bmpFn);
...
IBitmapControl *
GUIHelper7::CreateHelpButton(IPlug *plug, IGraphics *graphics,
                             int bmpId, const char *bmpFn,
                             const char *fileName,
                             Position pos)
{
...
ITextControl *
GUIHelper7::AddValueText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper7::AddTitleText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper7::AddRadioLabelText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper7::AddVersionText(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper7::AddTrigger(ITriggerControl *trigger)
{
#if GUI_OBJECTS_SORTING
...
void
GUIHelper7::UpdateText(IPlugBase *plug, int paramIdx)
{
    if (plug->GetGUI())
...
IBitmapControl *
GUIHelper7::CreateShadow(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper7::CreateDiffuse(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn,
                           int x, int y, IBitmap *objectBitmap,
                           int nObjectFrames)
{
...
bool
GUIHelper7::CreateMultiDiffuse(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper7::CreateTextField(IPlug *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
...
int
GUIHelper7::GetTextOffset()
{
    return VALUE_TEXT_SIZE + VALUE_TEXT_OFFSET2;
}

void
GUIHelper7::CreateText(IPlug *plug, IGraphics *graphics,
                       const char *textStr,
                       int x, int y,
                       int size, char *font,
                       IText::EStyle style,
...
void
GUIHelper7::CreateKnobInternal(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper7::CreateKnobInternal2(IPlug *plug, IGraphics *graphics,
                               IBitmap *bitmap, IKnobMultiControl *control,
                               int x, int y, int param, const char *title,
                               int shadowId, const char *shadowFn,
                               int diffuseId, const char *diffuseFn,
...
ITextControl *
GUIHelper7::AddValueTextInternal(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
                                 int x, int y, int param,
...
void
GUIHelper7::CreateKnobLightingInternal(IPlug *plug, IGraphics *graphics,
                                       int shadowId, const char *shadowFn,
                                       int diffuseId, const char *diffuseFn,
...
IBitmapControl *
GUIHelper7::CreateTextFieldInternal(IPlug *plug, IGraphics *graphics,
                                    int textFieldId, const char *textFieldFn,
                                    int x, int y, IBitmap *bitmap, int nObjectFrames,
