...
#ifndef SpectralDiff_TrialMode6_h
#define SpectralDiff_TrialMode6_h
...
{
public:
    static void SetTrialMessage(Plugin *plug, IGraphics *graphics, GUIHelper9 *helper);
