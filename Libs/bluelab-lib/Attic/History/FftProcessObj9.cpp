...
void
FftProcessObj9::AddSamples(BL_FLOAT *samples, BL_FLOAT *scSamples, int numSamples)
{
...
void
FftProcessObj9::ProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer,
                                     WDL_TypedBuf<BL_FLOAT> *scBuffer) {}

void
FftProcessObj9::SamplesToFftMagns(const WDL_TypedBuf<BL_FLOAT> &inSamples,
...
void
FftProcessObj9::NextSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj9::GetResultOutBuffer(BL_FLOAT *output, int nFrames)
{
    // Should not happen
...
bool
FftProcessObj9::Process(BL_FLOAT *input, BL_FLOAT *output,
...
void
FftProcessObj9::NormalizeFftValues(WDL_TypedBuf<BL_FLOAT> *magns)
{
    BL_FLOAT sum = 0.0f;
...
void
FftProcessObj9::ApplyAnalysisWindow(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj9::ApplySynthesisWindow(WDL_TypedBuf<BL_FLOAT> *samples)
{
    // Multiply the samples by analysis window
...
void
FftProcessObj9::ComputeFft(const WDL_TypedBuf<BL_FLOAT> &samples,
                           WDL_TypedBuf<WDL_FFT_COMPLEX> *fftSamples,
                           int freqRes)
{
