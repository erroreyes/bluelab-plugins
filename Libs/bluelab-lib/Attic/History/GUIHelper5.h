...
#ifndef __Transient__GUIHelper5__
#define __Transient__GUIHelper5__
...
#if USE_GRAPH_OGL
    GraphControl7 *CreateGraph7(IPlug *plug, IGraphics *graphics, int param,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
#endif /* defined(__Transient__GUIHelper5__) */
