...
#ifndef __Transient__FftProcessObj7__
#define __Transient__FftProcessObj7__
...
public:
    ...
    FftProcessObj7(int bufferSize, int oversampling = 2, int freqRes = 1,
                   bool normalize = true,
...
#endif /* defined(__Transient__FftProcessObj7__) */
