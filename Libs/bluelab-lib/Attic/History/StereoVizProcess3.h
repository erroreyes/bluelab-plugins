...
#ifndef __BL_PitchShift__StereoVizProcess3__
#define __BL_PitchShift__StereoVizProcess3__
...
class StereoVizVolRender3;
class StereoVizProcess3 : public MultichannelProcess
{
public:
    enum DisplayMode
    {
    ...
    StereoVizProcess3(int bufferSize,
                        BL_FLOAT overlapping, BL_FLOAT oversampling,
                        BL_FLOAT sampleRate);
    
    virtual ~StereoVizProcess3();
    ...
    void SetVolRender(StereoVizVolRender3 *volRender);
...
protected:
    ...
    // Vol Render
    StereoVizVolRender3 *mVolRender;
