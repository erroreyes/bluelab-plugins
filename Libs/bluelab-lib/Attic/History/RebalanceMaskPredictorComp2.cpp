//
//  RebalanceMaskPredictorComp2.cpp
//  BL-Rebalance
//
...
RebalanceMaskPredictorComp2::RebalanceMaskPredictorComp2(int bufferSize,
...
RebalanceMaskPredictorComp2::~RebalanceMaskPredictorComp2()
{
#if USE_SOFT_MASK_N
    delete mSoftMasking;
#endif
...
void
RebalanceMaskPredictorComp2::Reset()
{
...
void
RebalanceMaskPredictorComp2::Reset(int bufferSize, int overlapping,
...
#if FORCE_SAMPLE_RATE
void
RebalanceMaskPredictorComp2::ProcessInputSamplesPre(vector<WDL_TypedBuf<BL_FLOAT> * > *ioSamples,
...
void
RebalanceMaskPredictorComp2::ProcessInputFft(vector<WDL_TypedBuf<WDL_FFT_COMPLEX> * > *ioFftSamples,
...
void
RebalanceMaskPredictorComp2::GetMaskVocal(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskVocal)
{
    *maskVocal = mMaskVocal;
}

void
RebalanceMaskPredictorComp2::GetMaskBass(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskBass)
{
    *maskBass = mMaskBass;
}

void
RebalanceMaskPredictorComp2::GetMaskDrums(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskDrums)
{
    *maskDrums = mMaskDrums;
}

void
RebalanceMaskPredictorComp2::GetMaskOther(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskOther)
{
    *maskOther = mMaskOther;
}

void
RebalanceMaskPredictorComp2::Downsample(WDL_TypedBuf<BL_FLOAT> *ioBuf,
                                       BL_FLOAT sampleRate)
{
#if FORCE_SAMPLE_RATE
...
void
RebalanceMaskPredictorComp2::Upsample(WDL_TypedBuf<BL_FLOAT> *ioBuf,
                                     BL_FLOAT sampleRate)
{
#if FORCE_SAMPLE_RATE
    sampleRate = SAMPLE_RATE;
...
#if FORCE_SAMPLE_RATE
void
RebalanceMaskPredictorComp2::SetPlugSampleRate(BL_FLOAT sampleRate)
{
    mPlugSampleRate = sampleRate;
...
#if USE_SOFT_MASK_N
void
RebalanceMaskPredictorComp2::SetUseSoftMasks(bool flag)
{
    mUseSoftMasks = flag;
...
void
RebalanceMaskPredictorComp2::UpsamplePredictedMask(WDL_TypedBuf<BL_FLOAT> *ioBuf,
                                                  BL_FLOAT sampleRate)
{
#if !FIX_UPSAMPLE_MEL
    if (RESAMPLE_FACTOR == 1)
...
void
RebalanceMaskPredictorComp2::PredictMask(//WDL_TypedBuf<BL_FLOAT> *result,
                                         WDL_TypedBuf<BL_FLOAT> *mask,
                                         ...
                                         BL_FLOAT sampleRate)
{
    ...
    model->Predict(mixBufHisto, &resultBuf, &maskBuf);
#endif
    WDL_TypedBuf<BL_FLOAT> maskBuf;
...
void
RebalanceMaskPredictorComp2::ColumnsToBuffer(WDL_TypedBuf<BL_FLOAT> *buf,
...
void
RebalanceMaskPredictorComp2::ColumnsToBuffer(WDL_TypedBuf<WDL_FFT_COMPLEX> *buf,
...
void
RebalanceMaskPredictorComp2::ComputeMasksComp(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskVocal,
...
void
RebalanceMaskPredictorComp2::ComputeLineMaskComp2(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskResult,
...
void
RebalanceMaskPredictorComp2::ComputeLineMaskComp(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskResult,
...
#if USE_SOFT_MASK_N
void
RebalanceMaskPredictorComp2::ComputeLineMask2(WDL_TypedBuf<BL_FLOAT> *maskResult,
                                             const WDL_TypedBuf<BL_FLOAT> &maskSource)
{
    int numFreqs = BUFFER_SIZE/2;
    int numCols = NUM_OUTPUT_COLS;
...
void
RebalanceMaskPredictorComp2::ComputeLineMasksSoft(WDL_TypedBuf<WDL_FFT_COMPLEX> *maskVocal,
...
#if FORCE_SAMPLE_RATE
void
RebalanceMaskPredictorComp2::InitResamplers()
{
    // In
...
void
RebalanceMaskPredictorComp2::CreateModel(const char *modelFileName,
...
void
RebalanceMaskPredictorComp2::ReduceMaskCols(WDL_TypedBuf<BL_FLOAT> *ioMask)
{
