...
ITextControl *
GUIHelper10::CreateValueText(Plugin *plug, IGraphics *graphics,
                             int width, int height, int x, int y,
                             const char *title)
{
    // #bl-iplug2
    IText text(VALUE_TEXT_SIZE, mValueTextColor,
               VALUE_TEXT_FONT, EAlign::Center);//, //IText::kStyleBold, IText::kAlignCenter,
    ...
    ITextControl *textControl =
            new ITextControl(/*plug,*/ rect, title, text);
...
#if 0
IKnobMultiControl *
GUIHelper10::CreateKnob(Plugin *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper10::CreateKnob2(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper10::CreateKnob4(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper10::CreateEnumKnob(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
...
IKnobMultiControl *
GUIHelper10::CreateKnob3(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper10::CreateKnob3Ex(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
                           int x, int y, int param, const char *title,
                           int shadowId, const char *shadowFn,
                           int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper10::CreateKnob5(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
GUIHelper10::CreateRadioButtons(Plugin *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper10::CreateToggleButton(Plugin *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               int x, int y, int param, const char *title,
                               int diffuseId, const char *diffuseFn,
                               Size size)
...
//IToggleButtonControl *
IControl *
GUIHelper10::CreateToggleButtonEx(Plugin *plug, IGraphics *graphics,
                                  int bmpId, const char *bmpFn, int bmpFrames,
                                  int x, int y, int param, const char *title,
                                  int diffuseId, const char *diffuseFn,
                                  Size size,
...
#if 0 // #bl-iplug2
VuMeterControl *
GUIHelper10::CreateVuMeter(Plugin *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
...
#if USE_GRAPH_OGL
GraphControl11 *
GUIHelper10::CreateGraph11(Plugin *plug, IGraphics *graphics,
...
GraphControl11 *
GUIHelper10::CreateGraph11(Plugin *plug, IGraphics *graphics, int param,
...
#if 0 // #bl-iplug2
IControl *
GUIHelper10::CreateFileSelector(Plugin *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
...
#if 0
IControl *
GUIHelper10::CreateButton(Plugin *plug, IGraphics *graphics,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         int x, int y, int param,
                         char *label)
{
...
#if 0 // #bl-iplug2
IControl *
GUIHelper10::CreateGUIResizeButton(Plugin *plug, IGraphics *graphics,
                                  int bmpId, const char *bmpFn, int bmpFrames,
                                  int x, int y, int param,
...
IControl *
GUIHelper10::CreateRolloverButton(Plugin *plug, IGraphics *graphics,
                                 int bmpId, const char *bmpFn, int bmpFrames,
                                 int x, int y, int param,
...
IControl *
GUIHelper10::CreateRolloverButtonContainer(Plugin *plug, IGraphics *graphics,
                                          int bmpId, const char *bmpFn, int bmpFrames,
                                          int x, int y, int param,
...
void
GUIHelper10::CreateVersion(Plugin *plug, IGraphics *graphics,
...
#if 0 // #bl-iplug2
IBitmapControl *
GUIHelper10::CreateBitmap(Plugin *plug, IGraphics *graphics,
                         int x, int y,
...
#if 0 // #bl-iplug2
IBitmapControl *
GUIHelper10::CreateShadows(Plugin *plug, IGraphics *graphics, int bmpId, const char *bmpFn)
{
...
// Static logo
IBitmapControl *
GUIHelper10::CreateLogo(Plugin *plug, IGraphics *graphics,
...
// Animated logo
IBitmapControl *
GUIHelper10::CreateLogoAnim(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
...
#if 0 // #bl-iplug2
IBitmapControl *
GUIHelper10::CreatePlugName(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
    IBitmap bmp = graphics->LoadIBitmap(bmpId, bmpFn);
...
#if 0 // #bl-iplug2
IBitmapControl *
GUIHelper10::CreateHelpButton(Plugin *plug, IGraphics *graphics,
                             int bmpId, const char *bmpFn,
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper10::AddValueText(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
ICaptionControl *
GUIHelper10::AddValueText3(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                          IText *text, int x, int y, int param, IBitmap *tfBitmap)
{
    //int width = bitmap->W;
    int height = bitmap->frameHeight();
...
GUIHelper10::MeasureText(IGraphics *graphics, const char *text, Size size)
{
    ...
    //                0, IText::kQualityDefault);
    IText titleText(titleTextSize, NULL, TITLE_TEXT_FONT,
                    EAlign::Center); // IText::kStyleBold,
                    //0, IText::kQualityDefault);
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper10::AddTitleText(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper10::AddTitleTextRight(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper10::AddRadioLabelText(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper10::AddVersionText(Plugin *plug, IGraphics *graphics,
                            IText *text, const char *versionStr, int x, int y)
{
    ...
    ITextControl *textControl =
                new ITextControl(rect, versionStr, *text);
...
void
GUIHelper10::UpdateText(PluginBase *plug, int paramIdx)
{
    if (plug->GetGUI())
...
void
GUIHelper10::ResetParameter(PluginBase *plug, int paramIdx)
{
    if (plug->GetGUI())
    {
...
#if 0 // bl-iplug2
bool
GUIHelper10::PromptForFile(Plugin *plug, EFileAction action, WDL_String *result,
                          char* dir, char* extensions)
{
    WDL_String file;
...
#if 0 // bl-iplug2
IBitmapControl *
GUIHelper10::CreateShadow(Plugin *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn,
...
#if 0 // bl-iplug2
void
GUIHelper10::CreateGraphOverlay(Plugin *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
                                int x, int y, IBitmap *objectBitmap,
...
#if 0 // bl-iplug2
IBitmapControl *
GUIHelper10::CreateDiffuse(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn,
                           int x, int y, IBitmap *objectBitmap,
                           int nObjectFrames)
{
...
#if 0 // bl-iplug2
bool
GUIHelper10::CreateMultiDiffuse(Plugin *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
...
#if 0 // bl-iplug2
IBitmapControl *
GUIHelper10::CreateTextField(Plugin *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
...
#if 0 // bl-iplug2
ITextControl *
GUIHelper10::CreateText(Plugin *plug, IGraphics *graphics,
                       const char *textStr,
                       int x, int y,
                       int size, char *font,
                       ETextStyle style,
...
ITextControl *
GUIHelper10::CreateTitleText(Plugin *plug, IGraphics *graphics, int width,
                            const char *title, int x, int y, EAlign align,
                            Size size, BL_FLOAT titleTextOffsetY)
{
    int titleTextSize = TITLE_TEXT_SIZE;
...
ITextControl *
GUIHelper10::CreateUSTText(Plugin *plug, IGraphics *graphics, int textSize, int width,
                           const IColor &color,
                           ...
                           BL_FLOAT textOffsetX, BL_FLOAT textOffsetY)
{
 ...
 //              IText::kStyleBold, align,
  //             0, IText::kQualityDefault);
    ...
    ITextControl *textControl = new ITextControl(rect, str, text);
...
// UST
IControl *
GUIHelper10::CreateSwitch(Plugin *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
                          int x, int y, int param)
{
    IBitmap bitmap = graphics->LoadIBitmap(bmpId, bmpFn, bmpFrames);
...
void
GUIHelper10::UpdateFrequencyAxis(GraphControl11 *graph,
...
#if 0
void
GUIHelper10::CreateKnobInternal(Plugin *plug, IGraphics *graphics,
                               ...
                               bool doubleTextField)
{
    ...
    // Title
    AddTitleText(plug, graphics, bitmap, title, x, y, EAlign::Center, size);
    ...
    CreateKnobLightingInternal(plug, graphics, shadowId, shadowFn,
                               diffuseId, diffuseFn, x, y, bitmap,
                               bitmap->N());
...
void
GUIHelper10::CreateKnobInternal2(Plugin *plug, IGraphics *graphics,
                               IBitmap *bitmap, IKnobMultiControl *control,
                               int x, int y, int param, const char *title,
                               int shadowId, const char *shadowFn,
                               int diffuseId, const char *diffuseFn,
...
void
GUIHelper10::CreateKnobInternal3(Plugin *plug, IGraphics *graphics,
                                IBitmap *bitmap, IKnobMultiControl *control,
                                int x, int y, int param, const char *title,
                                int shadowId, const char *shadowFn,
                                int diffuseId, const char *diffuseFn,
...
void
GUIHelper10::CreateKnobInternal3Ex(Plugin *plug, IGraphics *graphics,
                                   IBitmap *bitmap, IKnobMultiControl *control,
                                   int x, int y, int param, const char *title,
                                   int shadowId, const char *shadowFn,
                                   int diffuseId, const char *diffuseFn,
...
void
GUIHelper10::CreateKnobInternal4(Plugin *plug, IGraphics *graphics,
                                IBitmap *bitmap, IKnobMultiControl *control,
                                int x, int y, int param, const char *title,
                                int shadowId, const char *shadowFn,
                                int diffuseId, const char *diffuseFn,
...
void
GUIHelper10::CreateKnobInternal5(Plugin *plug, IGraphics *graphics,
                                IBitmap *bitmap, IKnobMultiControl *control,
                                int x, int y, int param, const char *title,
                                int shadowId, const char *shadowFn,
                                int diffuseId, const char *diffuseFn,
...
ITextControl *
GUIHelper10::AddValueTextInternal(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                                 int x, int y, int param,
...
ICaptionControl *
GUIHelper10::AddValueTextInternal3(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                                  int x, int y, int param,
                                  bool addValueText, IText **ioValueText,
                                  IBitmap *tfBitmap)
{
...
ICaptionControl *
GUIHelper10::AddValueTextInternal5(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                                  int x, int y, int param,
                                  bool addValueText, IText **ioValueText,
                                  IBitmap *tfBitmap)
{
...
void
GUIHelper10::CreateKnobLightingInternal(Plugin *plug, IGraphics *graphics,
                                       int shadowId, const char *shadowFn,
                                       int diffuseId, const char *diffuseFn,
...
IBitmapControl *
GUIHelper10::CreateTextFieldInternal(Plugin *plug, IGraphics *graphics,
                                    int textFieldId, const char *textFieldFn,
                                    int x, int y, IBitmap *bitmap, int nObjectFrames,
