...
#ifndef __Transient__GUIHelper4__
#define __Transient__GUIHelper4__
...
#if USE_GRAPH_OGL
    GraphControl6 *CreateGraph6(IPlug *plug, IGraphics *graphics, int param,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
#endif /* defined(__Transient__GUIHelper4__) */
