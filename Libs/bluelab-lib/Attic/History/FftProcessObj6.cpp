                               ...
                               enum SynthesisMethod sMethod, bool skipFFT)
{
    ...
    //BL_FLOAT cola = Window::CheckCOLA(&mAnalysisWindow, mOversampling);
...
void
FftProcessObj6::AddSamples(BL_FLOAT *samples, int numSamples)
{
...
void
FftProcessObj6::ProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer) {}
...
void
FftProcessObj6::GetResultOutBuffer(BL_FLOAT *output, int nFrames)
{
    // Should not happen
...
BL_FLOAT
FftProcessObj6::ComputeHanningWinFactor(const WDL_TypedBuf<BL_FLOAT> &window)
{
    if (mOversampling == 1)
        return 1.0;
...
bool
FftProcessObj6::Process(BL_FLOAT *input, BL_FLOAT *output, int nFrames)
{
...
void
FftProcessObj6::NormalizeFftValues(WDL_TypedBuf<BL_FLOAT> *magns)
{
    BL_FLOAT sum = 0.0f;
...
void
FftProcessObj6::ComputeFft(const WDL_TypedBuf<BL_FLOAT> *samples,
