...
ITextControl *
GUIHelper9::CreateValueText(Plugin *plug, IGraphics *graphics,
                             int width, int height, int x, int y,
                             const char *title)
{
    // #bl-iplug2
    IText text((float)VALUE_TEXT_SIZE, mValueTextColor,
               VALUE_TEXT_FONT, /*ETextStyle::Bold,*/ EAlign::Center);
    ...
    // #bl-iplug2
    ITextControl *textControl = new ITextControl(/*plug,*/ rect, title, text);
...
#if 0
IKnobMultiControl *
GUIHelper9::CreateKnob(Plugin *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper9::CreateKnob2(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper9::CreateKnob4(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper9::CreateEnumKnob(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
...
IKnobMultiControl *
GUIHelper9::CreateKnob3(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
// From GUIHelper10
IKnobMultiControl *
GUIHelper9::CreateKnob3Ex(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
                           int x, int y, int param, const char *title,
                           int shadowId, const char *shadowFn,
                           int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper9::CreateKnob5(Plugin *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
GUIHelper9::CreateRadioButtons(Plugin *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
IRadioButtonsControl *
GUIHelper9::CreateRadioButtonsEx(Plugin *plug, IGraphics *graphics,
                                 int bmpId, const char *bmpFn, int bmpFrames,
                                 int x, int y, int numButtons, int size, int param,
                                 bool horizontalFlag, const char *title,
                                 int diffuseId, const char *diffuseFn,
...
GUIHelper9::CreateToggleButton(Plugin *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               int x, int y, int param, const char *title,
                               int diffuseId, const char *diffuseFn,
                               Size size)
...
// From GUIHelper10
IControl *
GUIHelper9::CreateToggleButtonEx(Plugin *plug, IGraphics *graphics,
                                 int bmpId, const char *bmpFn, int bmpFrames,
                                 int x, int y, int param, const char *title,
                                 int diffuseId, const char *diffuseFn,
                                 Size size,
...
#if 0
VuMeterControl *
GUIHelper9::CreateVuMeter(Plugin *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
...
#if USE_GRAPH_OGL
GraphControl11 *
GUIHelper9::CreateGraph10(Plugin *plug, IGraphics *graphics,
                          ...
                          IBitmap **oBitmap, bool useBgBitmap)
{
  // From GUIHelper10
    ...
    GraphControl11 *control = CreateGraph10(plug, graphics, param, x, y,
...
GraphControl11 *
GUIHelper9::CreateGraph10(Plugin *plug, IGraphics *graphics, int param,
			  ...
			  int numCurves, int numPoints, IBitmap *bgBitmap)
{
    ...
    GraphControl11 *control = new GraphControl11(plug, graphics, rect, param, numCurves, numPoints, pPath.Get());
...
#if 0
IControl *
GUIHelper9::CreateFileSelector(Plugin *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
...
#if 0 // #bl-iplug2
IControl *
GUIHelper9::CreateButton(Plugin *plug, IGraphics *graphics,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         int x, int y, int param,
                         char *label)
{
...
#if 0 // #bl-iplug2
IControl *
GUIHelper9::CreateGUIResizeButton(Plugin *plug, IGraphics *graphics,
                                  int bmpId, const char *bmpFn, int bmpFrames,
                                  int x, int y, int param,
...
#if 0 // #bl-iplug2
IControl *
GUIHelper9::CreateRolloverButton(Plugin *plug, IGraphics *graphics,
                                 int bmpId, const char *bmpFn, int bmpFrames,
                                 int x, int y, int param,
...
IControl *
GUIHelper9::CreateRolloverButtonContainer(Plugin *plug, IGraphics *graphics,
                                          int bmpId, const char *bmpFn, int bmpFrames,
                                          int x, int y, int param,
...
void
GUIHelper9::CreateVersion(Plugin *plug, IGraphics *graphics,
                          const char *versionStr, Position pos)
{
    ...
    if (pos == LOWER_RIGHT)
    {
        int strWidth = (int)(strlen(versionStrV)*VERSION_TEXT_SIZE);
    ...
    IText versionText(VERSION_TEXT_SIZE, mVersionTextColor, VERSION_TEXT_FONT, textAlign);
...
#if 0 // #bl-implug2
IBitmapControl *
GUIHelper9::CreateBitmap(Plugin *plug, IGraphics *graphics,
                         int x, int y,
...
IBitmapControl *
GUIHelper9::CreateShadows(Plugin *plug, IGraphics *graphics, int bmpId, const char *bmpFn)
{
...
// Static logo
IBitmapControl *
GUIHelper9::CreateLogo(Plugin *plug, IGraphics *graphics,
...
// Animated logo
IBitmapControl *
GUIHelper9::CreateLogoAnim(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
...
#if 0 // #bl-iplug2
IBitmapControl *
GUIHelper9::CreatePlugName(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
    IBitmap bmp = graphics->LoadIBitmap(bmpId, bmpFn);
...
#if 0 // #bl-iplug2
IBitmapControl *
GUIHelper9::CreateHelpButton(Plugin *plug, IGraphics *graphics,
                             int bmpId, const char *bmpFn,
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper9::AddValueText(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
#if 0 // #bl-iplug2
ICaptionControl *
GUIHelper9::AddValueText3(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                          IText *text, int x, int y, int param, IBitmap *tfBitmap)
{
    //int width = bitmap->W;
    int height = bitmap->frameHeight();
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper9::AddTitleText(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper9::AddTitleTextRight(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                              ...
                              Size size, BL_FLOAT titleTextOffsetX, BL_FLOAT titleTextOffsetY)
{
    ...
    //                IText::kStyleBold, align,
    //                0, IText::kQualityDefault);
    IText titleText(titleTextSize, mTitleTextColor, TITLE_TEXT_FONT, align);
                    //IText::kStyleNormal
                    //IText::kStyleBold, align,
                    //0, IText::kQualityDefault);
    ...
    ITextControl *textControl = new ITextControl(rect, title, titleText);
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper9::AddRadioLabelText(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper9::AddVersionText(Plugin *plug, IGraphics *graphics,
                            IText *text, const char *versionStr, int x, int y)
{
    ...
    ITextControl *textControl = new ITextControl(rect, versionStr, *text);
...
#if 0 // #bl-iplug
void
GUIHelper9::UpdateText(Plugin *plug, int paramIdx)
{
    if (plug->GetGUI())
...
void
GUIHelper9::ResetParameter(Plugin *plug, int paramIdx)
{
    if (plug->GetGUI())
    {
...
#if 0 // #bl-iplug
bool
GUIHelper9::PromptForFile(Plugin *plug, EFileAction action, WDL_String *result,
                          char* dir, char* extensions)
{
    WDL_String file;
...
#if 0 // #bl-iplug
IBitmapControl *
GUIHelper9::CreateShadow(Plugin *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn,
...
#if 0 // #bl-iplug
IBitmapControl *
GUIHelper9::CreateDiffuse(Plugin *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn,
                           int x, int y, IBitmap *objectBitmap,
                           int nObjectFrames)
{
...
#if 0 // #bl-iplug
bool
GUIHelper9::CreateMultiDiffuse(Plugin *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
...
#if 0 // #bl-iplug
IBitmapControl *
GUIHelper9::CreateTextField(Plugin *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
...
#if 0 // #bl-iplug2
ITextControl *
GUIHelper9::CreateText(Plugin *plug, IGraphics *graphics,
                       const char *textStr,
                       int x, int y,
                       int size, char *font,
                       ETextStyle style,
...
ITextControl *
GUIHelper9::CreateTitleText(Plugin *plug, IGraphics *graphics, int width,
                            const char *title, int x, int y, EAlign align,
                            Size size, BL_FLOAT titleTextOffsetY)
{
    int titleTextSize = TITLE_TEXT_SIZE;
...
void
GUIHelper9::UpdateFrequencyAxis(GraphControl11 *graph,
...
#if 0
void
GUIHelper9::GUIResizeParamChange(Plugin *plug, int paramNum,
...
#if 0
void
GUIHelper9::GUIResizeOnWindowResizePre(Plugin *plug, GraphControl11 *graph,
...
#if 0
void
GUIHelper9::GUIResizeOnWindowResizePost(Plugin *plug, GraphControl11 *graph)
{
    IGraphics *pGraphics = plug->GetGUI();
...
#if 0
void
GUIHelper9::CreateKnobInternal(Plugin *plug, IGraphics *graphics,
...
void
GUIHelper9::CreateKnobInternal2(Plugin *plug, IGraphics *graphics,
                               IBitmap *bitmap, IKnobMultiControl *control,
                               int x, int y, int param, const char *title,
                               int shadowId, const char *shadowFn,
                               int diffuseId, const char *diffuseFn,
                               ...
                               bool doubleTextField)
{
    ...
    AddTitleText(plug, graphics, bitmap, title, x,
                 y + yoffset + 2*TITLE_TEXT_SIZE, EAlign::Center);
...
#if 0
void
GUIHelper9::CreateKnobInternal3(Plugin *plug, IGraphics *graphics,
                                IBitmap *bitmap, IKnobMultiControl *control,
                                int x, int y, int param, const char *title,
                                int shadowId, const char *shadowFn,
                                int diffuseId, const char *diffuseFn,
...
// From GUIHelper10
void
GUIHelper9::CreateKnobInternal3Ex(Plugin *plug, IGraphics *graphics,
                                  IBitmap *bitmap, IKnobMultiControl *control,
                                  int x, int y, int param, const char *title,
                                  int shadowId, const char *shadowFn,
                                  int diffuseId, const char *diffuseFn,
...
void
GUIHelper9::CreateKnobInternal4(Plugin *plug, IGraphics *graphics,
                                IBitmap *bitmap, IKnobMultiControl *control,
                                int x, int y, int param, const char *title,
                                int shadowId, const char *shadowFn,
                                int diffuseId, const char *diffuseFn,
...
void
GUIHelper9::CreateKnobInternal5(Plugin *plug, IGraphics *graphics,
                                IBitmap *bitmap, IKnobMultiControl *control,
                                int x, int y, int param, const char *title,
                                int shadowId, const char *shadowFn,
                                int diffuseId, const char *diffuseFn,
...
ITextControl *
GUIHelper9::AddValueTextInternal(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                                 int x, int y, int param,
                                 bool addValueText, IText **ioValueText,
                                 IBitmap *tfBitmap)
{
    IText *valueText = new IText(VALUE_TEXT_SIZE, mValueTextColor,
                                 VALUE_TEXT_FONT, EAlign::Center);
                        //         //IText::kStyleNormal
...
ICaptionControl *
GUIHelper9::AddValueTextInternal3(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                                  int x, int y, int param,
                                  bool addValueText, IText **ioValueText,
                                  IBitmap *tfBitmap)
{
...
//                                 0, IText::kQualityDefault,
  //                               &pTextEntreBGColor, &pTextEntreFGColor);
    IText *valueText = new IText(VALUE_TEXT_SIZE, mValueTextColor,
                                 VALUE_TEXT_FONT,
                                 //IText::kStyleNormal
                                 EAlign::Center, EVAlign::Middle, 0,
                                 pTextEntreBGColor, pTextEntreFGColor);
...
ICaptionControl *
GUIHelper9::AddValueTextInternal5(Plugin *plug, IGraphics *graphics, IBitmap *bitmap,
                                  int x, int y, int param,
                                  bool addValueText, IText **ioValueText,
                                  IBitmap *tfBitmap)
{
...
void
GUIHelper9::CreateKnobLightingInternal(Plugin *plug, IGraphics *graphics,
                                       int shadowId, const char *shadowFn,
                                       int diffuseId, const char *diffuseFn,
...
IBitmapControl *
GUIHelper9::CreateTextFieldInternal(Plugin *plug, IGraphics *graphics,
                                    int textFieldId, const char *textFieldFn,
                                    int x, int y, IBitmap *bitmap, int nObjectFrames,
                                    bool doubleTextField, IBitmap *outBmp)
{
    ...
    return result;
        ...
        for (int i = 0; i < in.size(); i++)
        {
            ...
            BLUtils::ResizeFillZeros(&chan, BUFFER_SIZE);
        }
#endif
