...
FftProcessObj13::FftProcessObj13(int bufferSize, int overlapping, int freqRes,
...
FftProcessObj13::~FftProcessObj13() {}

void
FftProcessObj13::Reset(int overlapping, int freqRes)
{
    if (overlapping > 0)
...
void
FftProcessObj13::DBG_SetCorrectEnvelope1(bool flag)
{
    mCorrectEnvelope1 = flag;
}

void
FftProcessObj13::DBG_SetEnvelopeAutoAlign(bool flag)
{
    mEnvelopeAutoAlign = flag;
}

void
FftProcessObj13::DBG_SetCorrectEnvelope2(bool flag)
{
    mCorrectEnvelope2 = flag;
}

void
FftProcessObj13::SetDebugMode(bool flag)
{
    mDebugMode = flag;
}

void
FftProcessObj13::AddSamples(BL_FLOAT *samples, BL_FLOAT *scSamples, int numSamples)
{
...
void
FftProcessObj13::ProcessFftBuffer(WDL_TypedBuf<WDL_FFT_COMPLEX> *ioBuffer,
                                  const WDL_TypedBuf<WDL_FFT_COMPLEX> *scBuffer) {}

void
FftProcessObj13::ProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer,
                                     WDL_TypedBuf<BL_FLOAT> *scBuffer) {}

void
FftProcessObj13::PreProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer) {}

void
FftProcessObj13::PostProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer) {}

void
FftProcessObj13::UnapplyAnalysisWindowSamples(WDL_TypedBuf<BL_FLOAT> *ioBuffer)
{
    BLUtils::UnapplyWindow(ioBuffer, mAnalysisWindow, 2);
}

void
FftProcessObj13::UnapplyAnalysisWindowFft(WDL_TypedBuf<BL_FLOAT> *magns,
...
void
FftProcessObj13::SamplesToFft(const WDL_TypedBuf<BL_FLOAT> &inSamples,
...
void
FftProcessObj13::SamplesToFftMagns(const WDL_TypedBuf<BL_FLOAT> &inSamples,
                                   WDL_TypedBuf<BL_FLOAT> *outFftMagns)
{
    int numSamples = inSamples.GetSize();
    int numPaddedSamples = BLUtils::NextPowerOfTwo(numSamples);
...
void
FftProcessObj13::FftToSamples(const WDL_TypedBuf<WDL_FFT_COMPLEX> &fftBuffer,
...
void
FftProcessObj13::FftToSamples(const WDL_TypedBuf<BL_FLOAT> &fftMagns,
...
void
FftProcessObj13::HalfFftToSamples(const WDL_TypedBuf<BL_FLOAT> &fftMagns,
                                  const  WDL_TypedBuf<BL_FLOAT> &fftPhases,
                                  WDL_TypedBuf<BL_FLOAT> *outSamples)
{
    outSamples->Resize(fftMagns.GetSize());
...
void
FftProcessObj13::ProcessOneBuffer()
{
...
void
FftProcessObj13::ProcessOneBuffer(const WDL_TypedBuf<BL_FLOAT> &inBuffer,
                                  ...
                                  WDL_TypedBuf<BL_FLOAT> *outBuffer)
{
    ...
    else
    {
        ...
        FftProcessObj13::FftToSamples(mFftBuf, &samples0);
...
#define MAGNS_COEFF 2.0
        ...
        //FftProcessObj13::FftToSamples(mSortedFftBuf, &samples1);
...
#define MAGNS_COEFF2 2.0
    ...
    if (mDebugMode)
    {
        ...
        FftProcessObj13::SamplesToFft(*outBuffer, &resultMagns, &resultPhases);
...
void
FftProcessObj13::NextSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj13::GetResultOutBuffer(BL_FLOAT *output, int nFrames)
{
...
bool
FftProcessObj13::Process(BL_FLOAT *input, BL_FLOAT *output,
...
void
FftProcessObj13::NormalizeFftValues(WDL_TypedBuf<BL_FLOAT> *magns)
{
    BL_FLOAT sum = 0.0f;
...
void
FftProcessObj13::ApplyAnalysisWindow(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj13::ApplyAnalysisWindowInv(WDL_TypedBuf<BL_FLOAT> *samples)
{
    // Multiply the samples by analysis window
    // The window can be identity if necessary (no analysis window, or no overlap)
    for (int i = 0; i < samples->GetSize(); i++)
...
void
FftProcessObj13::ApplySynthesisWindow(WDL_TypedBuf<BL_FLOAT> *samples)
{
    // Multiply the samples by analysis window
...
void
FftProcessObj13::ApplySynthesisWindowNorm(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj13::ApplyInverseWindow(WDL_TypedBuf<WDL_FFT_COMPLEX> *fftSamples,
...
void
FftProcessObj13::ApplyInverseWindow(WDL_TypedBuf<BL_FLOAT> *magns,
                                    const WDL_TypedBuf<BL_FLOAT> &phases,
                                    const WDL_TypedBuf<BL_FLOAT> &window,
                                    const WDL_TypedBuf<BL_FLOAT> *originEnvelope)
{
...
void
FftProcessObj13::MakeWindows(int bufSize, int overlapping,
...
void
FftProcessObj13::ComputeFft(const WDL_TypedBuf<BL_FLOAT> &samples,
                            WDL_TypedBuf<WDL_FFT_COMPLEX> *fftSamples,
                            int freqRes)
{
...
void
FftProcessObj13::ComputeInverseFft(const WDL_TypedBuf<WDL_FFT_COMPLEX> &fftSamples,
