...
void
Graph::SetCurveFillAlpha(int curveNum, BL_FLOAT alpha)
{
    if (curveNum >= MAX_NUM_CURVES)
        return;
...
void
Graph::AddPointValue(BL_FLOAT val, int r, int g, int b)
{
...
void
Graph::AddLineValue(int curveNum, BL_FLOAT val)
{
    if (curveNum >= MAX_NUM_CURVES)
        return;
...
void
Graph::DrawCurve(BL_FLOAT val, BL_FLOAT prevValue, LICE_pixel color)
{
...
void
Graph::FillCurve(BL_FLOAT val, LICE_pixel color, BL_FLOAT alpha)
{
    int x = mBackBitmap->getWidth() - 1;
    int y = (int)((1.0 - val)*mBackBitmap->getHeight());
...
void
Graph::DrawCurveSV(BL_FLOAT val, BL_FLOAT prevValue, LICE_pixel color)
{
    int x0 = 0;
...
void
Graph::FillCurveSV(BL_FLOAT val, LICE_pixel color, BL_FLOAT alpha)
{
    int x0 = 0;
    int y0 = (int)((1.0 - val)*mBackBitmap->getHeight());
