...
GraphCurve3::GraphCurve3(int numValues)
{
    mYdBScale = false;
    mMinY = 0.0;
    mMaxY = 1.0;
...
GraphCurve3::~GraphCurve3() {}

void
GraphCurve3::ResetNumValues(int numValues)
{
    mNumValues = numValues;
...
void
GraphCurve3::SetYScale(bool dBFlag, BL_FLOAT minY, BL_FLOAT maxY)
{
    mYdBScale = dBFlag;
    mMinY = minY;
    mMaxY = maxY;
...
void
GraphCurve3::FillAllValues(BL_FLOAT val)
{
...
void
GraphCurve3::SetValues(const WDL_TypedBuf<BL_FLOAT> *values)
{
...
void
GraphCurve3::SetValue(BL_FLOAT t, BL_FLOAT val)
{
...
void
GraphCurve3::PushValue(BL_FLOAT val)
{
    if (mDoSmooth)
    {
