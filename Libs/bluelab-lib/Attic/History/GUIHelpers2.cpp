...
IKnobMultiControl *
GUIHelpers2::CreateKnobWithText(IPlug *plug, IGraphics *graphics,
                                IBitmap *bitmap,
                                int x, int y, int param, const char *label,
                                IText **ioText, bool addText,
                                ITextControl **ioTextControl, int yoffset)
{
    ...
    if ((ioText == NULL) || addText)
    {
        ITextControl *textControl = AddText(plug, graphics, bitmap, text, x, y + yoffset, param);
        if (ioTextControl != NULL)
            *ioTextControl = textControl;
    }
...
IKnobMultiControl *
GUIHelpers2::CreateEnumKnobWithText(IPlug *plug, IGraphics *graphics,
                                    IBitmap *bitmap,
...
GUIHelpers2::AddText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap, IText *text, int x, int y, int param)
{
    ...
    ITextControl *textControl = new ICaptionControl(plug,
