...
// NIKO-WIN
// Test, for avoiding display bug (knob text no well displayed, masked) 
#define ENABLE_SHADOWS 0

IColor GUIHelper6::mValueTextColor = IColor(255,
                                             VALUE_TEXT_COLOR_R,
                                             VALUE_TEXT_COLOR_G,
                                             VALUE_TEXT_COLOR_B);

GUIHelper6::GUIHelper6()
{
...
void
GUIHelper6::AddAllObjects(IGraphics *graphics)
{
#if GUI_OBJECTS_SORTING
...
ITextControl *
GUIHelper6::CreateValueText(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper6::CreateKnob(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper6::CreateKnob2(IPlug *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper6::CreateEnumKnob(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper6::CreateRadioButtons(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper6::CreateToggleButton(IPlug *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               int x, int y, int param, const char *title,
                               int diffuseId, const char *diffuseFn)
{
...
VuMeterControl *
GUIHelper6::CreateVuMeter(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
...
#if USE_GRAPH_OGL
GraphControl8 *
GUIHelper6::CreateGraph8(IPlug *plug, IGraphics *graphics, int param,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         ...
                         IBitmap **oBitmap)
{
    ...
    GraphControl8 *control = CreateGraph8(plug, graphics, param, x, y,
                         ...
                         int numCurves, int numPoints)
{
    ...
    GraphControl8 *control = new GraphControl8(plug, rect, param, numCurves, numPoints, pPath.Get());
...
void
GUIHelper6::CreateVersion(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper6::CreateBitmap(IPlug *plug, IGraphics *graphics,
                         int x, int y,
...
IBitmapControl *
GUIHelper6::CreateShadows(IPlug *plug, IGraphics *graphics, int bmpId, const char *bmpFn)
{
...
IBitmapControl *
GUIHelper6::CreateLogo(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper6::CreatePlugName(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
    IBitmap bmp = graphics->LoadIBitmap(bmpId, bmpFn);
...
IBitmapControl *
GUIHelper6::CreateHelpButton(IPlug *plug, IGraphics *graphics,
                             int bmpId, const char *bmpFn,
...
ITextControl *
GUIHelper6::AddValueText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper6::AddTitleText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper6::AddRadioLabelText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper6::AddVersionText(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper6::AddTrigger(ITriggerControl *trigger)
{
#if GUI_OBJECTS_SORTING
...
void
GUIHelper6::UpdateText(IPlugBase *plug, int paramIdx)
{
    if (plug->GetGUI())
...
IBitmapControl *
GUIHelper6::CreateShadow(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper6::CreateDiffuse(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn,
                           int x, int y, IBitmap *objectBitmap,
                           int nObjectFrames)
{
...
bool
GUIHelper6::CreateMultiDiffuse(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper6::CreateTextField(IPlug *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
...
int
GUIHelper6::GetTextOffset()
{
    return VALUE_TEXT_SIZE + VALUE_TEXT_OFFSET2;
}

void
GUIHelper6::CreateText(IPlug *plug, IGraphics *graphics,
                       const char *textStr,
                       int x, int y,
                       int size, char *font,
                       IText::EStyle style,
...
void
GUIHelper6::CreateKnobInternal(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper6::CreateKnobInternal2(IPlug *plug, IGraphics *graphics,
                               IBitmap *bitmap, IKnobMultiControl *control,
                               int x, int y, int param, const char *title,
                               int shadowId, const char *shadowFn,
                               int diffuseId, const char *diffuseFn,
...
ITextControl *
GUIHelper6::AddValueTextInternal(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
void
GUIHelper6::CreateKnobLightingInternal(IPlug *plug, IGraphics *graphics,
                                       int shadowId, const char *shadowFn,
                                       int diffuseId, const char *diffuseFn,
...
IBitmapControl *
GUIHelper6::CreateTextFieldInternal(IPlug *plug, IGraphics *graphics,
                                    int textFieldId, const char *textFieldFn,
                                    int x, int y, IBitmap *bitmap, int nObjectFrames,
