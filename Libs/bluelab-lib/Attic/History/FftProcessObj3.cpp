...
void
FftProcessObj3::AddSamples(BL_FLOAT *samples, int numSamples)
{
...
void
FftProcessObj3::ProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer) {}
...
void
FftProcessObj3::GetResultOutBuffer(BL_FLOAT *output, int nFrames)
{
    // Should not happen
...
bool
FftProcessObj3::Process(BL_FLOAT *input, BL_FLOAT *output, int nFrames)
{
    // Process the data
