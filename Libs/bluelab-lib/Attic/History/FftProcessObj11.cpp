...
FftProcessObj11::FftProcessObj11(int bufferSize, int overlapping, int freqRes,
...
FftProcessObj11::~FftProcessObj11() {}

void
FftProcessObj11::Reset(int overlapping, int freqRes)
{
    if (overlapping > 0)
    ...
    BLUtils::ResizeFillZeros(&mSortedFftBuf, bufSize);
    BLUtils::ResizeFillZeros(&mResultTmpChunk, bufSize);
   
    BLUtils::ResizeFillZeros(&mSortedFftBufSc, bufSize);
...
void
FftProcessObj11::AddSamples(BL_FLOAT *samples, BL_FLOAT *scSamples, int numSamples)
{
...
void
FftProcessObj11::ProcessFftBuffer(WDL_TypedBuf<WDL_FFT_COMPLEX> *ioBuffer,
                                  const WDL_TypedBuf<WDL_FFT_COMPLEX> *scBuffer) {}

void
FftProcessObj11::ProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer,
                                     WDL_TypedBuf<BL_FLOAT> *scBuffer) {}

void
FftProcessObj11::SamplesToFft(const WDL_TypedBuf<BL_FLOAT> &inSamples,
...
void
FftProcessObj11::SamplesToFftMagns(const WDL_TypedBuf<BL_FLOAT> &inSamples,
                                   WDL_TypedBuf<BL_FLOAT> *outFftMagns)
{
    int numSamples = inSamples.GetSize();
    int numPaddedSamples = BLUtils::NextPowerOfTwo(numSamples);
...
void
FftProcessObj11::ProcessOneBuffer()
{
    ...
    if (mKeepSynthesisEnergy)
        energy0 = BLUtils::ComputeAbsAvg(copySamplesBuf);
...
void
FftProcessObj11::NextSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj11::GetResultOutBuffer(BL_FLOAT *output, int nFrames)
{
...
bool
FftProcessObj11::Process(BL_FLOAT *input, BL_FLOAT *output,
...
void
FftProcessObj11::NormalizeFftValues(WDL_TypedBuf<BL_FLOAT> *magns)
{
    BL_FLOAT sum = 0.0f;
...
void
FftProcessObj11::FillSecondHalf(WDL_TypedBuf<WDL_FFT_COMPLEX> *ioBuffer)
{
...
void
FftProcessObj11::ApplyAnalysisWindow(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj11::ApplySynthesisWindow(WDL_TypedBuf<BL_FLOAT> *samples)
{
    // Multiply the samples by analysis window
...
void
FftProcessObj11::ApplySynthesisWindowNorm(WDL_TypedBuf<BL_FLOAT> *samples)
{
...
void
FftProcessObj11::ComputeFft(const WDL_TypedBuf<BL_FLOAT> &samples,
                            WDL_TypedBuf<WDL_FFT_COMPLEX> *fftSamples,
                            int freqRes)
{
...
void
FftProcessObj11::ComputeInverseFft(const WDL_TypedBuf<WDL_FFT_COMPLEX> &fftSamples,
