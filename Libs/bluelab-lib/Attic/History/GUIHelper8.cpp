...
IColor GUIHelper8::mValueTextColor = IColor(255,
                                             VALUE_TEXT_COLOR_R,
                                             VALUE_TEXT_COLOR_G,
                                             VALUE_TEXT_COLOR_B);

GUIHelper8::GUIHelper8()
{
...
void
GUIHelper8::AddAllObjects(IGraphics *graphics)
{
#if GUI_OBJECTS_SORTING
...
ITextControl *
GUIHelper8::CreateValueText(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper8::CreateKnob(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper8::CreateKnob2(IPlug *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper8::CreateEnumKnob(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper8::CreateRadioButtons(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper8::CreateToggleButton(IPlug *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               int x, int y, int param, const char *title,
                               int diffuseId, const char *diffuseFn)
{
...
VuMeterControl *
GUIHelper8::CreateVuMeter(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
...
#if USE_GRAPH_OGL
GraphControl10 *
GUIHelper8::CreateGraph10(IPlug *plug, IGraphics *graphics, int param,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         ...
                         int numCurves, int numPoints)
{
    ...
    GraphControl10 *control = new GraphControl10(plug, rect, param, numCurves, numPoints, pPath.Get());
...
IControl *
GUIHelper8::CreateFileSelector(IPlug *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               ...
                               bool promptForFile)
{
    ...
    if (promptForFile)
    {
        // Must create a IBitmapControl, otherwise the bitmap won't be displayed
        CreateBitmap(plug, graphics,
                     x, y,
                     bmpId, bmpFn,
                     -1, NULL /*IBitmap **ioBmp*/);
...
IControl *
GUIHelper8::CreateButton(IPlug *plug, IGraphics *graphics,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         int x, int y, int param,
                         char *label)
{
...
IControl *
GUIHelper8::CreateGUIResizeButton(IPlug *plug, IGraphics *graphics,
                                  int bmpId, const char *bmpFn, int bmpFrames,
                                  int x, int y, int param,
...
void
GUIHelper8::CreateVersion(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper8::CreateBitmap(IPlug *plug, IGraphics *graphics,
                         int x, int y,
...
IBitmapControl *
GUIHelper8::CreateShadows(IPlug *plug, IGraphics *graphics, int bmpId, const char *bmpFn)
{
...
IBitmapControl *
GUIHelper8::CreateLogo(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper8::CreatePlugName(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
    IBitmap bmp = graphics->LoadIBitmap(bmpId, bmpFn);
...
IBitmapControl *
GUIHelper8::CreateHelpButton(IPlug *plug, IGraphics *graphics,
                             int bmpId, const char *bmpFn,
...
ITextControl *
GUIHelper8::AddValueText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper8::AddTitleText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper8::AddRadioLabelText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper8::AddVersionText(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper8::AddTrigger(ITriggerControl *trigger)
{
#if GUI_OBJECTS_SORTING
...
void
GUIHelper8::UpdateText(IPlugBase *plug, int paramIdx)
{
    if (plug->GetGUI())
...
IBitmapControl *
GUIHelper8::CreateShadow(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper8::CreateDiffuse(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn,
                           int x, int y, IBitmap *objectBitmap,
                           int nObjectFrames)
{
...
bool
GUIHelper8::CreateMultiDiffuse(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper8::CreateTextField(IPlug *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
...
int
GUIHelper8::GetTextOffset()
{
    return VALUE_TEXT_SIZE + VALUE_TEXT_OFFSET2;
}

void
GUIHelper8::CreateText(IPlug *plug, IGraphics *graphics,
                       const char *textStr,
                       int x, int y,
                       int size, char *font,
                       IText::EStyle style,
...
void
GUIHelper8::AddControl(IControl *control)
{
#if GUI_OBJECTS_SORTING
    mWidgets.push_back(control);
#else
...
void
GUIHelper8::CreateKnobInternal(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper8::CreateKnobInternal2(IPlug *plug, IGraphics *graphics,
                               IBitmap *bitmap, IKnobMultiControl *control,
                               int x, int y, int param, const char *title,
                               int shadowId, const char *shadowFn,
                               int diffuseId, const char *diffuseFn,
...
ITextControl *
GUIHelper8::AddValueTextInternal(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
                                 int x, int y, int param,
...
void
GUIHelper8::CreateKnobLightingInternal(IPlug *plug, IGraphics *graphics,
                                       int shadowId, const char *shadowFn,
                                       int diffuseId, const char *diffuseFn,
...
IBitmapControl *
GUIHelper8::CreateTextFieldInternal(IPlug *plug, IGraphics *graphics,
                                    int textFieldId, const char *textFieldFn,
                                    int x, int y, IBitmap *bitmap, int nObjectFrames,
