...
#ifndef __BL_Rebalance__RebalanceMaskPredictorComp4__
#define __BL_Rebalance__RebalanceMaskPredictorComp4__
...
class RebalanceMaskPredictorComp4 : public MultichannelProcess
{
public:
    enum Quality
    {
    ...
    RebalanceMaskPredictorComp4(int bufferSize,
                               BL_FLOAT overlapping, BL_FLOAT oversampling,
                               BL_FLOAT sampleRate,
                               IGraphics *graphics);
    
    virtual ~RebalanceMaskPredictorComp4();
...
#endif /* defined(__BL_Rebalance__RebalanceMaskPredictorComp4__) */
