...
public:
    ...
    static IKnobMultiControl *CreateKnobWithText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
                                                int x, int y, int param, const char *label, IText **text = NULL, bool addText = true,
                                                 ITextControl **ioTextControl = NULL, int yoffset = 0);
    
    static IKnobMultiControl *CreateEnumKnobWithText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
                                                     int x, int y, int param,
                                                     BL_FLOAT sensivity,
                                                     const char *label, IText **text = NULL,
                                                     int yoffset = 0);
    
    static ITextControl *AddText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap, IText *text, int x, int y, int param);
