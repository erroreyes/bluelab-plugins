...
IColor GUIHelper5::mValueTextColor = IColor(255,
                                             VALUE_TEXT_COLOR_R,
                                             VALUE_TEXT_COLOR_G,
                                             VALUE_TEXT_COLOR_B);

GUIHelper5::GUIHelper5()
{
...
void
GUIHelper5::AddAllObjects(IGraphics *graphics)
{
#if GUI_OBJECTS_SORTING
...
ITextControl *
GUIHelper5::CreateValueText(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper5::CreateKnob(IPlug *plug, IGraphics *graphics,
...
IKnobMultiControl *
GUIHelper5::CreateKnob2(IPlug *plug, IGraphics *graphics,
                        int bmpId, const char *bmpFn, int bmpFrames,
                        int x, int y, int param, const char *title,
                        int shadowId, const char *shadowFn,
                        int diffuseId, const char *diffuseFn,
...
IKnobMultiControl *
GUIHelper5::CreateEnumKnob(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper5::CreateRadioButtons(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
GUIHelper5::CreateToggleButton(IPlug *plug, IGraphics *graphics,
                               int bmpId, const char *bmpFn, int bmpFrames,
                               int x, int y, int param, const char *title,
                               int diffuseId, const char *diffuseFn)
{
...
VuMeterControl *
GUIHelper5::CreateVuMeter(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn, int bmpFrames,
...
#if USE_GRAPH_OGL
GraphControl7 *
GUIHelper5::CreateGraph7(IPlug *plug, IGraphics *graphics, int param,
                         int bmpId, const char *bmpFn, int bmpFrames,
                         ...
                         IBitmap **oBitmap)
{
    ...
    GraphControl7 *control = CreateGraph7(plug, graphics, param, x, y,
                         ...
                         int numCurves, int numPoints)
{
    ...
    GraphControl7 *control = new GraphControl7(plug, rect, param, numCurves, numPoints, pPath.Get());
...
void
GUIHelper5::CreateVersion(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper5::CreateBitmap(IPlug *plug, IGraphics *graphics,
                         int x, int y,
...
IBitmapControl *
GUIHelper5::CreateShadows(IPlug *plug, IGraphics *graphics, int bmpId, const char *bmpFn)
{
...
IBitmapControl *
GUIHelper5::CreateLogo(IPlug *plug, IGraphics *graphics,
...
IBitmapControl *
GUIHelper5::CreatePlugName(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn, Position pos)
{
    IBitmap bmp = graphics->LoadIBitmap(bmpId, bmpFn);
...
IBitmapControl *
GUIHelper5::CreateHelpButton(IPlug *plug, IGraphics *graphics,
                             int bmpId, const char *bmpFn,
                             const char *fileName,
                             Position pos)
{
...
ITextControl *
GUIHelper5::AddValueText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper5::AddTitleText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper5::AddRadioLabelText(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
ITextControl *
GUIHelper5::AddVersionText(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper5::AddTrigger(ITriggerControl *trigger)
{
#if GUI_OBJECTS_SORTING
...
void
GUIHelper5::UpdateText(IPlugBase *plug, int paramIdx)
{
    if (plug->GetGUI())
...
IBitmapControl *
GUIHelper5::CreateShadow(IPlug *plug, IGraphics *graphics,
                          int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper5::CreateDiffuse(IPlug *plug, IGraphics *graphics,
                           int bmpId, const char *bmpFn,
                           int x, int y, IBitmap *objectBitmap,
                           int nObjectFrames)
{
...
bool
GUIHelper5::CreateMultiDiffuse(IPlug *plug, IGraphics *graphics,
                                int bmpId, const char *bmpFn,
...
IBitmapControl *
GUIHelper5::CreateTextField(IPlug *plug, IGraphics *graphics,
                            int bmpId, const char *bmpFn,
                            int x, int y, IBitmap *objectBitmap,
...
int
GUIHelper5::GetTextOffset()
{
    return VALUE_TEXT_SIZE + VALUE_TEXT_OFFSET2;
}

void
GUIHelper5::CreateText(IPlug *plug, IGraphics *graphics,
                       const char *textStr,
                       int x, int y,
                       int size, char *font,
                       IText::EStyle style,
...
void
GUIHelper5::CreateKnobInternal(IPlug *plug, IGraphics *graphics,
...
void
GUIHelper5::CreateKnobInternal2(IPlug *plug, IGraphics *graphics,
                               IBitmap *bitmap, IKnobMultiControl *control,
                               int x, int y, int param, const char *title,
                               int shadowId, const char *shadowFn,
                               int diffuseId, const char *diffuseFn,
...
ITextControl *
GUIHelper5::AddValueTextInternal(IPlug *plug, IGraphics *graphics, IBitmap *bitmap,
...
void
GUIHelper5::CreateKnobLightingInternal(IPlug *plug, IGraphics *graphics,
                                       int shadowId, const char *shadowFn,
                                       int diffuseId, const char *diffuseFn,
...
IBitmapControl *
GUIHelper5::CreateTextFieldInternal(IPlug *plug, IGraphics *graphics,
                                    int textFieldId, const char *textFieldFn,
                                    int x, int y, IBitmap *bitmap, int nObjectFrames,
