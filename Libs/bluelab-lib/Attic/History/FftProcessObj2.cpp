...
void
FftProcessObj2::AddSamples(BL_FLOAT *samples, int numSamples)
{
...
void
FftProcessObj2::ProcessSamplesBuffer(WDL_TypedBuf<BL_FLOAT> *ioBuffer) {}
...
void
FftProcessObj2::GetResultOutBuffer(BL_FLOAT *output, int nFrames)
{
    // Should not happen
...
bool
FftProcessObj2::Process(BL_FLOAT *input, BL_FLOAT *output, int nFrames)
{
    // Process the data
