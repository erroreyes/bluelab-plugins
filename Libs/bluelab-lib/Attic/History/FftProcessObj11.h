...
#ifndef __Transient__FftProcessObj11__
#define __Transient__FftProcessObj11__
...
//
class FftProcessObj11 //: public BufProcessObj
{
public:
    enum AnalysisMethod
    {
    ...
    FftProcessObj11(int bufferSize, int overlapping = 2, int freqRes = 1,
...
#endif /* defined(__Transient__FftProcessObj11__) */
