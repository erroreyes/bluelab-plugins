...
SMVProcess3::SMVProcess3(int bufferSize,
...
void
SMVProcess3::Reset(int overlapping, int oversampling,
                         BL_FLOAT sampleRate)
{
    mOverlapping = overlapping;
    mOversampling = oversampling;
...
void
SMVProcess3::ProcessInputFft(vector<WDL_TypedBuf<WDL_FFT_COMPLEX> * > *ioFftSamples,
...
#if 0
void
SMVProcess3::GetWidthValues(WDL_TypedBuf<BL_FLOAT> *xValues,
...
void
SMVProcess3::SetDisplayMode(enum DisplayMode mode)
{
    mDisplayMode = mode;
...
void
SMVProcess3::SetAngularMode(bool flag)
{
    mAngularMode = flag;
...
void
SMVProcess3::SetStereoWidth(BL_FLOAT stereoWidth, bool recomputeAll)
{
...
void
SMVProcess3::SetVolRender(SMVVolRender3 *volRender)
{
...
void
SMVProcess3::TemporalSmoothing(WDL_TypedBuf<BL_FLOAT> *sourceRs,
...
void
SMVProcess3::SpatialSmoothing(WDL_TypedBuf<BL_FLOAT> *sourceRs,
                                    WDL_TypedBuf<BL_FLOAT> *sourceThetas)
{
...
void
SMVProcess3::NormalizeRs(WDL_TypedBuf<BL_FLOAT> *sourceRs,
                                bool discardClip)
{
    // 100 m
...
void
SMVProcess3::ComputeColorWeightsMagns(WDL_TypedBuf<BL_FLOAT> *outWeights,
...
void
SMVProcess3::ComputeColorWeightsFreqs(WDL_TypedBuf<BL_FLOAT> *outWeights,
...
int
SMVProcess3::GetDisplayRefreshRate()
{
...
#if 0
void
SMVProcess3::DiscardUnselected(WDL_TypedBuf<BL_FLOAT> *magns0,
...
void
SMVProcess3::DiscardUnselectedStereo(WDL_TypedBuf<BL_FLOAT> *magns0,
                                           WDL_TypedBuf<BL_FLOAT> *magns1,
...
void
SMVProcess3::ComputeSpectroY(WDL_TypedBuf<BL_FLOAT> *yValues, int numValues)
{
...
void
SMVProcess3::GetSelectedData(WDL_TypedBuf<WDL_FFT_COMPLEX> ioFftSamples[2])
{
...
void
SMVProcess3::ComputeResult(const WDL_TypedBuf<BL_FLOAT> magns[2],
...
void
SMVProcess3::ApplyStereoWidth(WDL_TypedBuf<WDL_FFT_COMPLEX> fftSamples[2])
{
    // Prepara fft data
    fftSamples[0].Resize(fftSamples[0].GetSize()*2);
    fftSamples[1].Resize(fftSamples[1].GetSize()*2);
