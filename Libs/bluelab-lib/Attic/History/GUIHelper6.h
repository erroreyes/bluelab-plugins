...
#ifndef __Transient__GUIHelper6__
#define __Transient__GUIHelper6__
...
public:
    ...
    VuMeterControl *CreateVuMeter(IPlug *plug, IGraphics *graphics,
                                  ...
                                  int x, int y, int param, const char *title,
                                  bool alignLeft, 
								  bool decreaseWhenIdle = true);
    
    
#if USE_GRAPH_OGL
    GraphControl8 *CreateGraph8(IPlug *plug, IGraphics *graphics, int param,
                                int bmpId, const char *bmpFn, int bmpFrames,
...
#endif /* defined(__Transient__GUIHelper6__) */
