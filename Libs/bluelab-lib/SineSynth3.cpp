...
#if 0
void
SineSynth3::ComputeSamplesWin(WDL_TypedBuf<BL_FLOAT> *samples)
{
#if !COMPUTE_SAS_SAMPLES_TABLE
...
void
SineSynth3::ComputeSamplesPartials(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
//
void
SineSynth3::ComputeSamplesSAS5(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
...
#if 0
void
SineSynth3::ComputeSamplesSASTable(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
    Utils::FillAllZero(samples);
...
#if 0
void
SineSynth3::ComputeSamplesSASTable2(WDL_TypedBuf<BL_FLOAT> *samples)
{
    samples->Resize(mBufferSize);
    Utils::FillAllZero(samples);
...
#if 0
bool
SineSynth3::FindPartial(BL_FLOAT freq)
{
...
#if 0
void
SineSynth3::GetPartial(PartialTracker5::Partial *result, int index, BL_FLOAT t)
{
...
#if 0
void
SineSynth3::GetPartial(Partial *result, int index, BL_FLOAT t)
{
