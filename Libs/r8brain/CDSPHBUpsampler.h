...
public:
	...
	static void getHBFilter( const R8B_FLOAT ReqAtten, const int SteepIndex,
		const R8B_FLOAT*& flt, int& fltt, R8B_FLOAT& att )
	{
		static const int FltCount = 11;
		static const R8B_FLOAT HBKernel_4[ 4 ] = { // att -64.9241 dB, frac 4.0
			6.1073830069265711e-001, -1.4463982571471876e-001,
			4.1136036923118187e-002, -7.4740105856914872e-003 };
		static const R8B_FLOAT HBKernel_5[ 5 ] = { // att -87.4775 dB, frac 4.0
			6.1553054142504338e-001, -1.5591352339398118e-001,
			5.2404802661298266e-002, -1.4230574348726146e-002,
			2.2457593805377831e-003 };
		static const R8B_FLOAT HBKernel_6[ 6 ] = { // att -104.5154 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_7[ 7 ] = { // att -120.6199 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_8[ 8 ] = { // att -136.5151 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_9[ 9 ] = { // att -152.3240 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_10[ 10 ] = { // att -168.0859 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_11[ 11 ] = { // att -183.7962 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_12[ 12 ] = { // att -199.4768 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_13[ 13 ] = { // att -215.1364 dB, frac 4.0
		...
		static const R8B_FLOAT HBKernel_14[ 14 ] = { // att -230.7526 dB, frac 4.0
		...
		static const R8B_FLOAT FltAttens[ FltCount ] = {
			64.9241, 87.4775, 104.5154, 120.6199, 136.5151, 152.3240,
			168.0859, 183.7962, 199.4768, 215.1364, 230.7526 };
		static const R8B_FLOAT* const FltPtrs[ FltCount ] = { HBKernel_4,
		...
		static const R8B_FLOAT HBKernel_7b[ 7 ] = { // StopAtten = -209.9472 dB
		...
		static const R8B_FLOAT HBKernel_8b[ 8 ] = { // StopAtten = -238.5612 dB
		...
		static const R8B_FLOAT FltAttensC[ FltCountC ] = {
			87.9438, 130.8862, 172.3191, 213.4984, 254.5179 };
		static const R8B_FLOAT* const FltPtrsC[ FltCountC ] = { HBKernel_2c,
			HBKernel_3c, HBKernel_4c, HBKernel_5c, HBKernel_6c };

		static const int FltCountD = 3; // 0.03125
		static const R8B_FLOAT HBKernel_2d[ 2 ] = { // StopAtten = -113.1456 dB
			5.6295152180538044e-001, -6.2953706070191726e-002 };
		static const R8B_FLOAT HBKernel_3d[ 3 ] = { // StopAtten = -167.1446 dB
			5.8621968728761675e-001, -9.8080551656624410e-002,
			1.1860868762030571e-002 };
		static const R8B_FLOAT HBKernel_4d[ 4 ] = { // StopAtten = -220.6519 dB
			5.9835028661892165e-001, -1.1999986095168852e-001,
			2.4132530901858028e-002, -2.4829565783680927e-003 };
		static const R8B_FLOAT FltAttensD[ FltCountD ] = {
			113.1456, 167.1446, 220.6519 };
		static const R8B_FLOAT* const FltPtrsD[ FltCountD ] = { HBKernel_2d,
			HBKernel_3d, HBKernel_4d };

		static const int FltCountE = 4; // 0.015625
		static const R8B_FLOAT HBKernel_1e[ 1 ] = { // StopAtten = -60.9962 dB
			5.0030136284718241e-001 };
		static const R8B_FLOAT HBKernel_2e[ 2 ] = { // StopAtten = -137.3130 dB
			5.6261293163934145e-001, -6.2613067826625832e-002 };
		static const R8B_FLOAT HBKernel_3e[ 3 ] = { // StopAtten = -203.2997 dB
			5.8600808139033378e-001, -9.7762185874608526e-002,
			1.1754104552667852e-002 };
		static const R8B_FLOAT HBKernel_4e[ 4 ] = { // StopAtten = -268.8561 dB
			5.9819599535791312e-001, -1.1972157884617740e-001,
			2.3977307400990484e-002, -2.4517239127622593e-003 };
		static const R8B_FLOAT FltAttensE[ FltCountE ] = {
			60.9962, 137.3130, 203.2997, 268.8561 };
		static const R8B_FLOAT* const FltPtrsE[ FltCountE ] = { HBKernel_1e,
			HBKernel_2e, HBKernel_3e, HBKernel_4e };

		static const int FltCountG = 3;
		static const R8B_FLOAT HBKernel_1g[ 1 ] = { // att -93.9165 dB, frac 256.0
			5.0001882524896712e-001 };
		static const R8B_FLOAT HBKernel_2g[ 2 ] = { // att -185.4886 dB, frac 256.0
			5.6250705922473820e-001, -6.2507059756319761e-002 };
		static const R8B_FLOAT HBKernel_3g[ 3 ] = { // att -275.5531 dB, frac 256.0
			5.8594191093025305e-001, -9.7662866644414148e-002,
			1.1720955714177778e-002 };
		static const R8B_FLOAT FltAttensG[ FltCountG ] = {
			93.9165, 185.4886, 275.5531 };
		static const R8B_FLOAT* const FltPtrsG[ FltCountG ] = { HBKernel_1g,
	...
	static void getHBFilterThird( const R8B_FLOAT ReqAtten, const int SteepIndex,
		const R8B_FLOAT*& flt, int& fltt, R8B_FLOAT& att )
	{
		static const int FltCount = 7;
		static const R8B_FLOAT HBKernel_3[ 3 ] = { // att -75.0994 dB, frac 6.0
			5.9381789425210385e-001, -1.1030344037819353e-001,
			1.6601396044066741e-002 };
		static const R8B_FLOAT HBKernel_4[ 4 ] = { // att -102.5310 dB, frac 6.0
			6.0388679447131843e-001, -1.3043900369548017e-001,
			3.0518777984447295e-002, -3.9738477033171900e-003 };
		static const R8B_FLOAT HBKernel_5[ 5 ] = { // att -126.5360 dB, frac 6.0
			6.1014115058940344e-001, -1.4393081816630204e-001,
			4.1760642892854860e-002, -8.9692183234068596e-003,
			9.9871340618369218e-004 };
		static const R8B_FLOAT HBKernel_6[ 6 ] = { // att -150.1830 dB, frac 6.0
		...
		static const R8B_FLOAT HBKernel_7[ 7 ] = { // att -173.7067 dB, frac 6.0
		...
		static const R8B_FLOAT HBKernel_8[ 8 ] = { // att -197.1454 dB, frac 6.0
		...
		static const R8B_FLOAT HBKernel_9[ 9 ] = { // att -220.5199 dB, frac 6.0
		...
		static const R8B_FLOAT HBKernel_2c[ 2 ] = { // att -102.9806 dB, frac 24.0
			5.6330232648142842e-001, -6.3309247177420730e-002 };
		static const R8B_FLOAT HBKernel_3c[ 3 ] = { // att -152.1187 dB, frac 24.0
			5.8643891113575064e-001, -9.8411593011501639e-002,
			1.1972706651455891e-002 };
		static const R8B_FLOAT HBKernel_4c[ 4 ] = { // att -200.6182 dB, frac 24.0
			5.9851012364429712e-001, -1.2028885240905723e-001,
			2.4294521088349529e-002, -2.5157924167197453e-003 };
		static const R8B_FLOAT HBKernel_5c[ 5 ] = { // att -248.8728 dB, frac 24.0
		...
		static const R8B_FLOAT HBKernel_1d[ 1 ] = { // att -48.6615 dB, frac 48.0
			5.0053598654836240e-001 };
		static const R8B_FLOAT HBKernel_2d[ 2 ] = { // att -127.3033 dB, frac 48.0
			5.6270074379958679e-001, -6.2701174487726163e-002 };
		static const R8B_FLOAT HBKernel_3d[ 3 ] = { // att -188.2989 dB, frac 48.0
			5.8606296210257025e-001, -9.7844644764129421e-002,
			1.1781683046197223e-002 };
		static const R8B_FLOAT HBKernel_4d[ 4 ] = { // att -248.8578 dB, frac 48.0
		...
		static const R8B_FLOAT* const FltPtrsD[ FltCountD ] = { HBKernel_1d,
			HBKernel_2d, HBKernel_3d, HBKernel_4d };

		static const int FltCountE = 3;
		static const R8B_FLOAT HBKernel_1e[ 1 ] = { // att -73.2782 dB, frac 96.0
			5.0013388897382527e-001 };
		static const R8B_FLOAT HBKernel_2e[ 2 ] = { // att -151.4076 dB, frac 96.0
			5.6255019604318290e-001, -6.2550222932385172e-002 };
		static const R8B_FLOAT HBKernel_3e[ 3 ] = { // att -224.4366 dB, frac 96.0
		...
		static const int FltCountG = 3;
		static const R8B_FLOAT HBKernel_1g[ 1 ] = { // att -101.2873 dB, frac 384.0
			5.0000836666064941e-001 };
		static const R8B_FLOAT HBKernel_2g[ 2 ] = { // att -199.5761 dB, frac 384.0
			5.6250313744967606e-001, -6.2503137554676916e-002 };
		static const R8B_FLOAT HBKernel_3g[ 3 ] = { // att -296.4833 dB, frac 384.0
	...
	CDSPHBUpsampler( const R8B_FLOAT ReqAtten, const int SteepIndex,
		const bool IsThird, const R8B_FLOAT PrevLatency )
	{
	...
	virtual R8B_FLOAT getLatencyFrac() const
	{
		return( LatencyFrac );
	}
	...
	virtual void clear()
	{
		...
		memset( &Buf[ ReadPos ], 0, fll * sizeof( R8B_FLOAT ));
	}

	virtual int process( R8B_FLOAT* ip, int l, R8B_FLOAT*& op0 )
	{
		R8BASSERT( l >= 0 );
		...
		while( l > 0 )
		{
			...
			R8B_FLOAT* const wp1 = Buf + WritePos;
			memcpy( wp1, ip, b * sizeof( R8B_FLOAT ));

			if( WritePos < flo )
			{
				const int c = min( b, flo - WritePos );
				memcpy( wp1 + BufLen, wp1, c * sizeof( R8B_FLOAT ));
			}
...
private:
	...
	static const int BufLenMask = BufLen - 1; ///< Mask used for quick buffer
		///< position wrapping.
		///<
	R8B_FLOAT Buf[ BufLen + 27 ]; ///< The ring buffer, including overrun
		///< protection for the largest filter.
		///<
	const R8B_FLOAT* fltp; ///< Half-band filter taps.
		///<
	...
	int Latency; ///< Initial latency that should be removed from the output.
		///<
	R8B_FLOAT LatencyFrac; ///< Fractional latency left on the output.
		///<
	...
	int LatencyLeft; ///< Latency left to remove.
		///<
	typedef void( *CConvolveFn )( R8B_FLOAT* op, R8B_FLOAT* const opend,
		const R8B_FLOAT* const flt, const R8B_FLOAT* const rp0, int& ReadPos0 ); ///<
...
#define R8BHBC1( fn ) \
	static void fn( R8B_FLOAT* op, R8B_FLOAT* const opend, const R8B_FLOAT* const flt, \
		const R8B_FLOAT* const rp0, int& ReadPos0 ) \
	{ \
		int rpos = ReadPos0; \
		while( op < opend ) \
		{ \
			const R8B_FLOAT* const rp = rp0 + rpos; \
			op[ 0 ] = rp[ 0 ]; \
			op[ 1 ] =
