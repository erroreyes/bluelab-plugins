...
FILES=$(find backup -name 'rebalance_*.weights' | sort -t _ -k 2 -g)
...
do
    ...
    ./dk-build/bl-darknet rebalance test cfg/sources.cfg cfg/rebalance.cfg $BACKUP_FILE -score-file training/test-pred-all.txt
