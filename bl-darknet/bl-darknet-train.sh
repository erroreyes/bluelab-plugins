...
./dk-build/bl-darknet rebalance train cfg/sources.cfg cfg/rebalance.cfg
#./dk-build/bl-darknet rebalance train cfg/sources.cfg cfg/rebalance.cfg backup/rebalance.backup
