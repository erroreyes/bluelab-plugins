...
// 32, 256, 64
#define IMG_WIDTH 32 // 64
#define IMG_HEIGHT 32 // 64
#define IMG_CHAN 4

//3, 32, 31, 63, 5
#define KERNEL_WIDTH 3 //1 //3 //1 // 3
#define KERNEL_HEIGHT 3 //1 //7 //3

// 1, 4 //width*height
// NOTE: crashes with NUM_FILTERS=1
#define NUM_FILTERS 4 //32*32 //4 //8 //4

// 1, 4
#define NUM_GROUPS 4 //1 //4

#define NUM_ITERS 10 //1 //10 //100

#define BATCH_NORM 0 //1 // 0

//
//#define KERNEL_INITIALIZER DARKNET_INITIALIZER
//#define KERNEL_INITIALIZER RANDOM_NORMAL
//#define KERNEL_INITIALIZER RANDOM_UNIFORM
//#define KERNEL_INITIALIZER GLOROT_NORMAL
//#define KERNEL_INITIALIZER GLOROT_UNIFORM
//#define KERNEL_INITIALIZER ZEROS
//#define KERNEL_INITIALIZER UNIFORM_ABS

#define KERNEL_INITIALIZER ONES
//#define KERNEL_INITIALIZER RANDOM_NORMAL

#define CONV_DECONV_COPY_WEIGHTS 1 //0

// conv2
void
run_tests_conv_layer_0(const char *test_name)
{
    int width = IMG_WIDTH;
    ...
    bl_save_image(l.out_w, l.out_h, nchan_out, l.output, fname2, FILL_IMG_ALPHA);
    free(fname2);
    ...
    bl_save_image(l.out_w, l.out_h, nchan_out, l.delta, fname3, FILL_IMG_ALPHA);
    free(fname3);
    ...
    bl_save_image(l.out_w, l.out_h, nchan_out, l.output, fname5, FILL_IMG_ALPHA);
    free(fname5);
...
// deconv2
void
run_tests_conv_layer_1(const char *test_name)
{
    int width = IMG_WIDTH;
    int height = IMG_HEIGHT;
    int nchan = IMG_CHAN;
...
// conv2 then deconv2
void
run_tests_conv_layer_2(const char *test_name)
{
    int width = IMG_WIDTH;
    int height = IMG_HEIGHT;
    int nchan = IMG_CHAN;
    ...
    char *fname2 = gen_fname(test_name, 2);
    bl_save_image(l1.out_w, l1.out_h, nchan_out1, l1.output, fname2, FILL_IMG_ALPHA);
    free(fname2);
    ...
    char *fname3 = gen_fname(test_name, 3);
    bl_save_image(l2.out_w, l2.out_h, nchan_out2, l2.output, fname3, FILL_IMG_ALPHA);
    free(fname3);
...
run_tests_conv_layer()
{
    ...
    run_tests_conv_layer_0("conv_layer_0");
    run_tests_conv_layer_1("conv_layer_1");
    run_tests_conv_layer_2("conv_layer_2");
}
