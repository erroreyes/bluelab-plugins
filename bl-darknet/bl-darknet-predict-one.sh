...
BACKUP_FILE=backup/rebalance_$BACKUP_NUM.weights

echo "Processing file: $BACKUP_FILE"

./dk-build/bl-darknet rebalance test cfg/sources.cfg cfg/rebalance.cfg $BACKUP_FILE -backup-num $BACKUP_NUM
