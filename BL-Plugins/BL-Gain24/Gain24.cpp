...
//
Gain24::Gain24(const InstanceInfo &info)
...
void
Gain24::MyMakeLayout(IGraphics *pGraphics)
{
    ENTER_PARAMS_MUTEX;
...
void
Gain24::ProcessBlock(iplug::sample **inputs, iplug::sample **outputs, int nFrames)
{
...
void
Gain24::CreateControls(IGraphics *pGraphics)
{
    if (mGUIHelper == NULL)
...
void
Gain24::OnParamChange(int paramIdx)
{
    if (!mIsInitialized)
        return;
