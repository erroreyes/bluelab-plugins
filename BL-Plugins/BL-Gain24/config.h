...
#define PLUG_CLASS_NAME Gain24

#define BUNDLE_NAME "BL-Gain24"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Gain24"
...
#define AUV2_ENTRY Gain24_Entry
#define AUV2_ENTRY_STR "Gain24_Entry"
#define AUV2_FACTORY Gain24_Factory
#define AUV2_VIEW_CLASS Gain24_View
#define AUV2_VIEW_CLASS_STR "Gain24_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Gain24\nGain24"
...
#define MANUAL_FN "BL-Gain24_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Gain24_manual-EN.pdf"
