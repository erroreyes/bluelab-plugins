...
#define PLUG_CLASS_NAME Gain60

#define BUNDLE_NAME "BL-Gain60"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Gain60"
...
#define AUV2_ENTRY Gain60_Entry
#define AUV2_ENTRY_STR "Gain60_Entry"
#define AUV2_FACTORY Gain60_Factory
#define AUV2_VIEW_CLASS Gain60_View
#define AUV2_VIEW_CLASS_STR "Gain60_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Gain60\nGain60"
...
#define MANUAL_FN "BL-Gain60_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Gain60_manual-EN.pdf"
