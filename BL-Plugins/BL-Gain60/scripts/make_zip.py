...
def  main():
  ...
  installer = "\installer\BL-Gain60-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Gain60-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Gain60_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Gain60-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Gain60-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
