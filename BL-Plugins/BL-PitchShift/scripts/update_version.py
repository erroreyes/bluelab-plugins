...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-PitchShift-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-PitchShift-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-PitchShift-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-PitchShift-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-PitchShift-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-PitchShift.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-PitchShift.iss",inplace=1):
