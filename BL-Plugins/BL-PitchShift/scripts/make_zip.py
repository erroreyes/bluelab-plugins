...
def  main():
  ...
  installer = "\installer\BL-PitchShift-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-PitchShift-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-PitchShift_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-PitchShift-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-PitchShift-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
