...
#define PLUG_CLASS_NAME StereoPan

#define BUNDLE_NAME "BL-StereoPan"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-StereoPan"
...
#define AUV2_ENTRY StereoPan_Entry
#define AUV2_ENTRY_STR "StereoPan_Entry"
#define AUV2_FACTORY StereoPan_Factory
#define AUV2_VIEW_CLASS StereoPan_View
#define AUV2_VIEW_CLASS_STR "StereoPan_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "StereoPan\nStereoPan"
...
#define MANUAL_FN "BL-StereoPan_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-StereoPan_manual-EN.pdf"
