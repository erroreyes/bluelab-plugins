...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-StereoPan-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoPan-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoPan-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoPan-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoPan-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-StereoPan.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-StereoPan.iss",inplace=1):
