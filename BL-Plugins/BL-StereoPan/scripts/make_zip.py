...
def  main():
  ...
  installer = "\installer\BL-StereoPan-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-StereoPan-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-StereoPan_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-StereoPan-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-StereoPan-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
