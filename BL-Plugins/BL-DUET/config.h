...
#define PLUG_CLASS_NAME DUET

#define BUNDLE_NAME "BL-DUET"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-DUET"
...
#define AUV2_ENTRY DUET_Entry
#define AUV2_ENTRY_STR "DUET_Entry"
#define AUV2_FACTORY DUET_Factory
#define AUV2_VIEW_CLASS DUET_View
#define AUV2_VIEW_CLASS_STR "DUET_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "DUET\nDUET"
...
#define MANUAL_FN "BL-DUET_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-DUET_manual-EN.pdf"
