...
def  main():
  ...
  installer = "\installer\BL-DUET-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-DUET-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-DUET_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-DUET-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-DUET-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
