...
def  main():
  ...
  installer = "\installer\BL-Bat-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Bat-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Bat_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Bat-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Bat-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
