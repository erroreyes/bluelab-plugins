...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Bat-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Bat-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Bat-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Bat-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Bat-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Bat.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Bat.iss",inplace=1):
