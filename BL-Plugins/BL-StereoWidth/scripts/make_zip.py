...
def  main():
  ...
  installer = "\installer\BL-StereoWidth-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-StereoWidth-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-StereoWidth_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-StereoWidth-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-StereoWidth-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
