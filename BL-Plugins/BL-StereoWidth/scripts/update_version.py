...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-StereoWidth-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoWidth-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoWidth-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoWidth-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-StereoWidth-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-StereoWidth.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-StereoWidth.iss",inplace=1):
