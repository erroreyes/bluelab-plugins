...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-ReverbDepth-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-ReverbDepth-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-ReverbDepth-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-ReverbDepth-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-ReverbDepth-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-ReverbDepth.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-ReverbDepth.iss",inplace=1):
