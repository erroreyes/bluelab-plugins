...
# TODO: generetage GUID for ReverbDepth (for the moment it is the same a BL-Reverb
PT_GUID=3D2FDB50-387F-11EA-8E4C-00505692C25A
...
sudo cp -R "${AAX_FINAL}" "${AAX_FINAL}_unsigned"
...
#if [ $DEMO == 1 ]
#then
#git checkout installer/BL-ReverbDepth.iss
#git checkout installer/BL-ReverbDepth.pkgproj
