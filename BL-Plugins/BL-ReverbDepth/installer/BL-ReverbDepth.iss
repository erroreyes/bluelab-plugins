...
DefaultDirName={pf}\BL-ReverbDepth
DefaultGroupName=BlueLab\BL-ReverbDepth
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=BL-ReverbDepth-v6.0.1[DEMO]-Installer
...
SetupIconFile=..\resources\BL-ReverbDepth.ico
UninstallIconFile=..\resources\BL-ReverbDepth.ico
...
[Messages]
WelcomeLabel1=Welcome to the BL-ReverbDepth Demo installer
SetupWindowTitle=BL-ReverbDepth [DEMO] installer
...
[Dirs] 
;Name: "{cf32}\Avid\Audio\Plug-Ins\BL-ReverbDepth.aaxplugin\"; Attribs: readonly; Components:aax_32; 
;; Name: "{cf64}\Avid\Audio\Plug-Ins\BL-ReverbDepth.aaxplugin\"; Attribs: readonly; Check: Is64BitInstallMode; Components:aax_64; 
;; Name: "{cf32}\VST3\BL-ReverbDepth.vst3\"; Attribs: readonly; Components:vst3_32; 
;; Name: "{cf64}\VST3\BL-ReverbDepth.vst3\"; Attribs: readonly; Check: Is64BitInstallMode; Components:vst3_64; 

[Files]
Source: "..\build-win\vst2\Win32\Release\BL-ReverbDepth.dll"; DestDir: {code:GetVST2Dir_32}; Check: not Is64BitInstallMode; Components:vst2_32; Flags: ignoreversion;
Source: "..\build-win\vst2\x64\Release\BL-ReverbDepth.dll"; DestDir: {code:GetVST2Dir_64}; Check: Is64BitInstallMode; Components:vst2_64; Flags: ignoreversion;

Source: "..\build-win\vst3\Win32\Release\BL-ReverbDepth.vst3"; DestDir: "{cf}\VST3\"; Check: not Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\build-win\vst3\x64\Release\BL-ReverbDepth.vst3"; DestDir: "{cf64}\VST3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion;

Source: "..\build-win\aax\Win32\Release\BL-ReverbDepth.aaxplugin"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\BL-ReverbDepth.aaxplugin\"; Components:aax_32; Flags: ignoreversion recursesubdirs;
Source: "..\build-win\aax\x64\Release\BL-ReverbDepth.aaxplugin"; DestDir: "{cf}\Avid\Audio\Plug-Ins\BL-ReverbDepth.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;

Source: "..\manual\BL-ReverbDepth_manual-EN.pdf"; DestDir: "{app}"
Source: "readme-win-demo.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
;Name: "{group}\BL-ReverbDepth"; Filename: "{app}\BL-ReverbDepth.exe"
Name: "{group}\User guide"; Filename: "{app}\BL-ReverbDepth_manual-EN.pdf"
;Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
;Name: "{group}\readme"; Filename: "{app}\readme.rtf"
Name: "{group}\Uninstall BL-ReverbDepth"; Filename: "{app}\unins000.exe"
