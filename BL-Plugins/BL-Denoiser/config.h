...
#define PLUG_CLASS_NAME Denoiser

#define BUNDLE_NAME "BL-Denoiser"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Denoiser"
...
#define AUV2_ENTRY Denoiser_Entry
#define AUV2_ENTRY_STR "Denoiser_Entry"
#define AUV2_FACTORY Denoiser_Factory
#define AUV2_VIEW_CLASS Denoiser_View
#define AUV2_VIEW_CLASS_STR "Denoiser_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Denoiser\nDenoiser"
#define AAX_PLUG_CATEGORY_STR "NoiseReduction"
...
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Denoiser_manual-EN.pdf"
