...
def  main():
  ...
  installer = "\installer\BL-Denoiser-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Denoiser-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Denoiser_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Denoiser-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Denoiser-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
