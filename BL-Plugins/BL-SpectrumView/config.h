...
#define PLUG_CLASS_NAME SpectrumView

#define BUNDLE_NAME "BL-SpectrumView"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-SpectrumView"
...
#define AUV2_ENTRY SpectrumView_Entry
#define AUV2_ENTRY_STR "SpectrumView_Entry"
#define AUV2_FACTORY SpectrumView_Factory
#define AUV2_VIEW_CLASS SpectrumView_View
#define AUV2_VIEW_CLASS_STR "SpectrumView_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "SpectrumView\nSpectrumView"
...
#define MANUAL_FN "BL-SpectrumView_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-SpectrumView_manual-EN.pdf"
