...
def  main():
  ...
  installer = "\installer\BL-SpectrumView-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-SpectrumView-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-SpectrumView_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-SpectrumView-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-SpectrumView-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
