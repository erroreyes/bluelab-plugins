...
def  main():
  ...
  installer = "\installer\BL-LoFi-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-LoFi-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-LoFi_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-LoFi-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-LoFi-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
