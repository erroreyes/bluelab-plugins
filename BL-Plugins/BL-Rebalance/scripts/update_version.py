...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Rebalance-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Rebalance-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Rebalance-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Rebalance-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Rebalance-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Rebalance.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Rebalance.iss",inplace=1):
