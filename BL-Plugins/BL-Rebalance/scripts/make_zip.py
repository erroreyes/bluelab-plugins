...
def  main():
  ...
  installer = "\installer\BL-Rebalance-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Rebalance-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Rebalance_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Rebalance-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Rebalance-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
