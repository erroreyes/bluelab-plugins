...
def  main():
  ...
  installer = "\installer\BL-Panogram-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Panogram-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Panogram_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Panogram-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Panogram-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
