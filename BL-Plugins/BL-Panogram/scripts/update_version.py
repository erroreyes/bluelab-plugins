...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Panogram-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Panogram-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Panogram-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Panogram-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Panogram-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Panogram.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Panogram.iss",inplace=1):
