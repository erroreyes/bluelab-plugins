...
#define PLUG_CLASS_NAME Panogram

#define BUNDLE_NAME "BL-Panogram"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Panogram"
...
#define AUV2_ENTRY Panogram_Entry
#define AUV2_ENTRY_STR "Panogram_Entry"
#define AUV2_FACTORY Panogram_Factory
#define AUV2_VIEW_CLASS Panogram_View
#define AUV2_VIEW_CLASS_STR "Panogram_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Panogram\nPanogram"
...
#define MANUAL_FN "BL-Panogram_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Panogram_manual-EN.pdf"
...
// Specific
#define BUTTON_DOWN_ARROW_FN "button-downarrow.png"
