...
def  main():
  ...
  installer = "\installer\BL-Air-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Air-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Air_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Air-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Air-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
