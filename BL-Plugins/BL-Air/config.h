...
#define PLUG_CLASS_NAME Air

#define BUNDLE_NAME "BL-Air"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Air"
...
#define AUV2_ENTRY Air_Entry
#define AUV2_ENTRY_STR "Air_Entry"
#define AUV2_FACTORY Air_Factory
#define AUV2_VIEW_CLASS Air_View
#define AUV2_VIEW_CLASS_STR "Air_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Air\nAir"
...
#define MANUAL_FN "BL-Air_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Air_manual-EN.pdf"
