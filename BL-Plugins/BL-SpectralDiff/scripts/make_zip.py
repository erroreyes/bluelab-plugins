...
def  main():
  ...
  installer = "\installer\BL-SpectralDiff-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-SpectralDiff-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-SpectralDiff_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-SpectralDiff-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-SpectralDiff-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
