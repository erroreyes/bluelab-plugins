...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-SpectralDiff-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SpectralDiff-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SpectralDiff-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SpectralDiff-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SpectralDiff-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-SpectralDiff.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-SpectralDiff.iss",inplace=1):
