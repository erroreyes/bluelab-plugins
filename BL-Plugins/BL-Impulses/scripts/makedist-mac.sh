...
PT_GUID=04D7C610-DC00-11E7-99ED-005056A204F3
...
then
  ...
  cp -R Examples installer/build-mac/
...
#if [ $DEMO == 1 ]
#then
#git checkout installer/BL-Impulses.iss
#git checkout installer/BL-Impulses.pkgproj
