...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Impulses-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Impulses-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Impulses-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Impulses-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Impulses-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Impulses.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Impulses.iss",inplace=1):
