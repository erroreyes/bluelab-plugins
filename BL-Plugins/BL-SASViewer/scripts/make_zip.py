...
def  main():
  ...
  installer = "\installer\BL-SASViewer-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-SASViewer-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-SASViewer_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-SASViewer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-SASViewer-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
