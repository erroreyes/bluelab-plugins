...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-SASViewer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SASViewer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SASViewer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SASViewer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SASViewer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-SASViewer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-SASViewer.iss",inplace=1):
