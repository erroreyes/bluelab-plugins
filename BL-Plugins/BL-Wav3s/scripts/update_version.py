...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Wav3s-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Wav3s-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Wav3s-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Wav3s-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Wav3s-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Wav3s.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Wav3s.iss",inplace=1):
