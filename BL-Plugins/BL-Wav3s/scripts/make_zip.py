...
def  main():
  ...
  installer = "\installer\BL-Wav3s-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Wav3s-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Wav3s_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Wav3s-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Wav3s-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
