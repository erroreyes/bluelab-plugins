...
//
Gain12::Gain12(const InstanceInfo &info)
...
void
Gain12::MyMakeLayout(IGraphics *pGraphics)
{
    ENTER_PARAMS_MUTEX;
...
void
Gain12::ProcessBlock(iplug::sample **inputs, iplug::sample **outputs, int nFrames)
{
...
void
Gain12::CreateControls(IGraphics *pGraphics)
{
    if (mGUIHelper == NULL)
...
void
Gain12::OnParamChange(int paramIdx)
{
    if (!mIsInitialized)
        return;
