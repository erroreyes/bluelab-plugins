...
def  main():
  ...
  installer = "\installer\BL-Gain12-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Gain12-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Gain12_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Gain12-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Gain12-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
