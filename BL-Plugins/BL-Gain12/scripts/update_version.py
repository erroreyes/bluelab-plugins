...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Gain12-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Gain12-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Gain12-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Gain12-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Gain12-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Gain12.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Gain12.iss",inplace=1):
