...
def  main():
  ...
  installer = "\installer\BL-Reverb-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Reverb-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Reverb_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Reverb-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Reverb-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
