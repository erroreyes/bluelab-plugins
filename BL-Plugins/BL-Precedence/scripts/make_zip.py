...
def  main():
  ...
  installer = "\installer\BL-Precedence-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Precedence-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Precedence_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Precedence-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Precedence-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
