...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Precedence-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Precedence-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Precedence-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Precedence-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Precedence-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Precedence.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Precedence.iss",inplace=1):
