...
#define PLUG_CLASS_NAME Precedence

#define BUNDLE_NAME "BL-Precedence"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Precedence"
...
// Origin IPlug2: 60:
// Origin Precedence: 25
// For Windows + VSynch
#define PLUG_FPS 60
#define PLUG_SHARED_RESOURCES 0
#define PLUG_HOST_RESIZE 0

#define AUV2_ENTRY Precedence_Entry
#define AUV2_ENTRY_STR "Precedence_Entry"
#define AUV2_FACTORY Precedence_Factory
#define AUV2_VIEW_CLASS Precedence_View
#define AUV2_VIEW_CLASS_STR "Precedence_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Precedence\nPrecedence"
...
#define MANUAL_FN "BL-Precedence_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Precedence_manual-EN.pdf"
