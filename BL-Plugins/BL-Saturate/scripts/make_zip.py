...
def  main():
  ...
  installer = "\installer\BL-Saturate-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Saturate-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Saturate_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Saturate-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Saturate-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
