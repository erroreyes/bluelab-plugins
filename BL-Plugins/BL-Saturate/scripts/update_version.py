...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Saturate-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Saturate-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Saturate-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Saturate-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Saturate-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Saturate.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Saturate.iss",inplace=1):
