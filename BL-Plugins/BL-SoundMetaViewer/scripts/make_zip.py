...
def  main():
  ...
  installer = "\installer\BL-SoundMetaViewer-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-SoundMetaViewer-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-SoundMetaViewer_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-SoundMetaViewer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-SoundMetaViewer-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
