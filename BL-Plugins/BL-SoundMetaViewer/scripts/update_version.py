...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-SoundMetaViewer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SoundMetaViewer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SoundMetaViewer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SoundMetaViewer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SoundMetaViewer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-SoundMetaViewer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-SoundMetaViewer.iss",inplace=1):
