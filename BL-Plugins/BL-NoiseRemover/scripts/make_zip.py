...
def  main():
  ...
  installer = "\installer\BL-NoiseRemover-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-NoiseRemover-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-NoiseRemover_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-NoiseRemover-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-NoiseRemover-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
