...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-NoiseRemover-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-NoiseRemover-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-NoiseRemover-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-NoiseRemover-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-NoiseRemover-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-NoiseRemover.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-NoiseRemover.iss",inplace=1):
