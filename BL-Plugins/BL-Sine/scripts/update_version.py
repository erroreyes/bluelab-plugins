...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Sine-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Sine-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Sine-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Sine-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Sine-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Sine.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Sine.iss",inplace=1):
