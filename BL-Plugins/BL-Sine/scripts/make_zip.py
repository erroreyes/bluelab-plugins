...
def  main():
  ...
  installer = "\installer\BL-Sine-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Sine-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Sine_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Sine-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Sine-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
