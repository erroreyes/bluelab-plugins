...
def  main():
  ...
  installer = "\installer\BL-SampleDelay-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-SampleDelay-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-SampleDelay_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-SampleDelay-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-SampleDelay-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
