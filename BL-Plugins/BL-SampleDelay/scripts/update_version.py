...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-SampleDelay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SampleDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SampleDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SampleDelay-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-SampleDelay-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-SampleDelay.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-SampleDelay.iss",inplace=1):
