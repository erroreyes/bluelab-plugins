...
#define PLUG_CLASS_NAME SampleDelay

#define BUNDLE_NAME "BL-SampleDelay"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-SampleDelay"
...
// Origin IPlug2: 60:
// Origin SampleDelay: 25
// For Windows + VSynch
#define PLUG_FPS 60
#define PLUG_SHARED_RESOURCES 0
#define PLUG_HOST_RESIZE 0

#define AUV2_ENTRY SampleDelay_Entry
#define AUV2_ENTRY_STR "SampleDelay_Entry"
#define AUV2_FACTORY SampleDelay_Factory
#define AUV2_VIEW_CLASS SampleDelay_View
#define AUV2_VIEW_CLASS_STR "SampleDelay_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "SampleDelay\nSampleDelay"
#define AAX_PLUG_CATEGORY_STR "Delay"
#define AAX_DOES_AUDIOSUITE 1

#define VST3_SUBCATEGORY "Fx|Delay"
...
#define MANUAL_FN "BL-SampleDelay_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-SampleDelay_manual-EN.pdf"
