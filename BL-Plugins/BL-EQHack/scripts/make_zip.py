...
def  main():
  ...
  installer = "\installer\BL-EQHack-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-EQHack-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-EQHack_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-EQHack-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-EQHack-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
