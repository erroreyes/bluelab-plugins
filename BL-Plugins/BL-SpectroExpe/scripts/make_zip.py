...
def  main():
  ...
  installer = "\installer\BL-SpectroExpe-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-SpectroExpe-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-SpectroExpe_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-SpectroExpe-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-SpectroExpe-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
