...
def  main():
  ...
  installer = "\installer\BL-GhostViewer-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-GhostViewer-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-GhostViewer_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-GhostViewer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-GhostViewer-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
