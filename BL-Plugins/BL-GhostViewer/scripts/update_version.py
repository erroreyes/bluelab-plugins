...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-GhostViewer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-GhostViewer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-GhostViewer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-GhostViewer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-GhostViewer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-GhostViewer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-GhostViewer.iss",inplace=1):
