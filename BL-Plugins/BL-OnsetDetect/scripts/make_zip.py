...
def  main():
  ...
  installer = "\installer\BL-OnsetDetect-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-OnsetDetect-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-OnsetDetect_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-OnsetDetect-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-OnsetDetect-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
