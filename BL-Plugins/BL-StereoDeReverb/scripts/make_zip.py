...
def  main():
  ...
  installer = "\installer\BL-StereoDeReverb-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-StereoDeReverb-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-StereoDeReverb_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-StereoDeReverb-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-StereoDeReverb-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
