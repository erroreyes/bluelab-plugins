...
def  main():
  ...
  installer = "\installer\BL-Infra-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Infra-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Infra_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Infra-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Infra-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
