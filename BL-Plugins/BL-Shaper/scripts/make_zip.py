...
def  main():
  ...
  installer = "\installer\BL-Shaper-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Shaper-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Shaper_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Shaper-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Shaper-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
