...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Shaper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Shaper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Shaper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Shaper-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Shaper-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Shaper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Shaper.iss",inplace=1):
