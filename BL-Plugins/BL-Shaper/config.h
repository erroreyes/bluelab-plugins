...
#define PLUG_CLASS_NAME Shaper

#define BUNDLE_NAME "BL-Shaper"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Shaper"
...
#define AUV2_ENTRY Shaper_Entry
#define AUV2_ENTRY_STR "Shaper_Entry"
#define AUV2_FACTORY Shaper_Factory
#define AUV2_VIEW_CLASS Shaper_View
#define AUV2_VIEW_CLASS_STR "Shaper_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Shaper\nShaper"
...
#define MANUAL_FN "BL-Shaper_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Shaper_manual-EN.pdf"
