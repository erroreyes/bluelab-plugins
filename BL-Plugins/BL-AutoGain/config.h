...
#define PLUG_CLASS_NAME AutoGain

#define BUNDLE_NAME "BL-AutoGain"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-AutoGain"
...
#define AUV2_ENTRY AutoGain_Entry
#define AUV2_ENTRY_STR "AutoGain_Entry"
#define AUV2_FACTORY AutoGain_Factory
#define AUV2_VIEW_CLASS AutoGain_View
#define AUV2_VIEW_CLASS_STR "AutoGain_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "AutoGain\nAutoGain"
...
#define MANUAL_FN "BL-AutoGain_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-AutoGain_manual-EN.pdf"
