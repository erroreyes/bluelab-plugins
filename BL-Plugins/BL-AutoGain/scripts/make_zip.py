...
def  main():
  ...
  installer = "\installer\BL-AutoGain-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-AutoGain-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-AutoGain_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-AutoGain-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-AutoGain-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
