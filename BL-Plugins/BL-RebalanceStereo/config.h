#define PLUG_NAME "BL-RebalanceStereo"
#define PLUG_MFR "BlueLab"
#define PLUG_VERSION_HEX 0x00060405
#define PLUG_VERSION_STR "6.4.5"
// http://service.steinberg.de/databases/plugin.nsf/plugIn?openForm
#define PLUG_UNIQUE_ID 'rebs' // Id set by hand now that the form is offline
...
#define PLUG_CLASS_NAME RebalanceStereo

#define BUNDLE_NAME "BL-RebalanceStereo"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-RebalanceStereo"
...
#define AUV2_ENTRY RebalanceStereo_Entry
#define AUV2_ENTRY_STR "RebalanceStereo_Entry"
#define AUV2_FACTORY RebalanceStereo_Factory
#define AUV2_VIEW_CLASS RebalanceStereo_View
#define AUV2_VIEW_CLASS_STR "RebalanceStereo_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "RebalanceStereo\nRebalanceStereo"
...
#define MANUAL_FN "BL-RebalanceStereo_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-RebalanceStereo_manual-EN.pdf"
