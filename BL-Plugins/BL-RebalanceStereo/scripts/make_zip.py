...
def  main():
  ...
  installer = "\installer\BL-RebalanceStereo-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-RebalanceStereo-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-RebalanceStereo_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-RebalanceStereo-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-RebalanceStereo-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
