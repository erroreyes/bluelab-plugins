...
def  main():
  ...
  installer = "\installer\BL-Spatializer-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Spatializer-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Spatializer_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Spatializer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Spatializer-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
