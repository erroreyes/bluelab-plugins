...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Spatializer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Spatializer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Spatializer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Spatializer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Spatializer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Spatializer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Spatializer.iss",inplace=1):
