...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Chroma-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Chroma-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Chroma-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Chroma-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Chroma-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Chroma.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Chroma.iss",inplace=1):
