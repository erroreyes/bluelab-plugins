...
def  main():
  ...
  installer = "\installer\BL-Chroma-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Chroma-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Chroma_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Chroma-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Chroma-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
