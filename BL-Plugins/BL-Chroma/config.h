...
#define PLUG_CLASS_NAME Chroma

#define BUNDLE_NAME "BL-Chroma"
#define BUNDLE_MFR "BlueLab"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "BL-Chroma"
...
#define AUV2_ENTRY Chroma_Entry
#define AUV2_ENTRY_STR "Chroma_Entry"
#define AUV2_FACTORY Chroma_Factory
#define AUV2_VIEW_CLASS Chroma_View
#define AUV2_VIEW_CLASS_STR "Chroma_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "BlLa"
#define AAX_PLUG_NAME_STR "Chroma\nChroma"
...
#define MANUAL_FN "BL-Chroma_manual-EN.pdf"
// For WIN32
#define MANUAL_FULLPATH_FN "manual\BL-Chroma_manual-EN.pdf"
