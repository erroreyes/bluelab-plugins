...
def  main():
  ...
  installer = "\installer\BL-Morpho-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\BL-Morpho-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\manual\BL-Morpho_manual-EN.pdf" 
  ]

  ZIPNAME = "BL-Morpho-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BL-Morpho-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
