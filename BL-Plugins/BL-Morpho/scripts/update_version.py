...
def main():
  ...
  plistpath = scriptpath + "/resources/BL-Morpho-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Morpho-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Morpho-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Morpho-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BL-Morpho-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BL-Morpho.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BL-Morpho.iss",inplace=1):
